...
describe(@"UAASDescribeScalingActivitiesResponse", ^
{
	it(@"should import an XML string.", ^
    {
	    ...
	    UAASDescribeScalingActivitiesResponse *describeScalingActivitiesResponse = [UAMTLXMLAdapter modelOfClass:[UAASDescribeScalingActivitiesResponse class] fromXMLNode:xmlDictionary error:&serialisationError];
