...
#define UADDXMLAssert(condition, desc, ...)                                                                 \
  do{                                                                                                     \
    if(!(condition)) {                                                                                    \
...
#define UADDXMLNotZombieAssert()                                                                            \
  do{                                                                                                     \
    if(UADDXMLIsZombie(genericPtr, self)) {                                                                      \
...
#define UADDLastErrorKey @"UADDXML:LastError"



/**
 * UADDXMLNode can represent several underlying types, such as xmlNodePtr, xmlDocPtr, xmlAttrPtr, xmlNsPtr, etc.
...
@interface UADDXMLNamespaceNode : UADDXMLNode
{
...
- (id)initWithNsPrimitive:(xmlNsPtr)ns nsParent:(xmlNodePtr)parent owner:(UADDXMLNode *)owner;

- (xmlNodePtr)_nsParentPtr;
- (void)_setNsParentPtr:(xmlNodePtr)parentPtr;

// Overrides several methods in UADDXMLNode
...
@interface UADDXMLAttributeNode : UADDXMLNode
{
...
- (id)initWithAttrPrimitive:(xmlAttrPtr)attr owner:(UADDXMLNode *)owner;
...
@interface UADDXMLInvalidNode : UADDXMLNode
{
}
...
@interface UADDXMLNode (PrivateAPI)
...
- (id)initWithPrimitive:(xmlKindPtr)kindPtr owner:(UADDXMLNode *)owner;
...
@interface UADDXMLElement (PrivateAPI)

+ (id)nodeWithElementPrimitive:(xmlNodePtr)node owner:(UADDXMLNode *)owner;
- (id)initWithElementPrimitive:(xmlNodePtr)node owner:(UADDXMLNode *)owner;
...
@interface UADDXMLDocument (PrivateAPI)

+ (id)nodeWithDocPrimitive:(xmlDocPtr)doc owner:(UADDXMLNode *)owner;
- (id)initWithDocPrimitive:(xmlDocPtr)doc owner:(UADDXMLNode *)owner;
