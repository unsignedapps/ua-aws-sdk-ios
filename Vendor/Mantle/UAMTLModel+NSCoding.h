...
// Defines how a UAMTLModel property key should be encoded into an archive.
//
// UAMTLModelEncodingBehaviorExcluded      - The property should never be encoded.
// UAMTLModelEncodingBehaviorUnconditional - The property should always be
//                                         encoded.
// UAMTLModelEncodingBehaviorConditional   - The object should be encoded only
//                                         if unconditionally encoded elsewhere.
//                                         This should only be used for object
//                                         properties.
typedef enum : NSUInteger {
    UAMTLModelEncodingBehaviorExcluded = 0,
    UAMTLModelEncodingBehaviorUnconditional,
    UAMTLModelEncodingBehaviorConditional,
} UAMTLModelEncodingBehavior;

// Implements default archiving and unarchiving behaviors for UAMTLModel.
@interface UAMTLModel (NSCoding) <NSCoding>
...
// The values of this dictionary should be boxed UAMTLModelEncodingBehavior
// values.
//
...
// behavior is UAMTLModelEncodingBehaviorConditional; otherwise, the default is
// UAMTLModelEncodingBehaviorUnconditional.
...
// The version of this UAMTLModel subclass.
//
...
// of UAMantle (before the `UAMTLModel+NSCoding` interface existed).
@interface UAMTLModel (OldArchiveSupport)
