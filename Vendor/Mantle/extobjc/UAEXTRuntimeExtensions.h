...
typedef enum {
     ...
     */
    UAMTL_propertyMemoryManagementPolicyAssign = 0,

    /**
     * The value is retained.
     */
    UAMTL_propertyMemoryManagementPolicyRetain,

    /**
     * The value is copied.
     */
    UAMTL_propertyMemoryManagementPolicyCopy
} UAMTL_propertyMemoryManagementPolicy;
...
typedef struct {
     ...
     * #UAMTL_propertyMemoryManagementPolicyAssign if #readonly is \c YES.
     */
    UAMTL_propertyMemoryManagementPolicy memoryManagementPolicy;
