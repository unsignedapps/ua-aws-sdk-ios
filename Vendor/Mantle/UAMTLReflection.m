...
SEL UAMTLSelectorWithKeyPattern(NSString *key, const char *suffix) {
...
SEL UAMTLSelectorWithCapitalizedKeyPattern(const char *prefix, NSString *key, const char *suffix) {
