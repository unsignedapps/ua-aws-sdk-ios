...
@class UAIAMGetUserResponse;

typedef void(^UAIAMGetUserRequestCompletionBlock)(UAIAMGetUserResponse *response, NSError *error);
typedef BOOL(^UAIAMGetUserRequestShouldContinueWaitingBlock)(UAIAMGetUserResponse *response, NSError *error);

@interface UAIAMGetUserRequest : UAIAMRequest

@property (nonatomic, copy) NSString *userName;
// @property (nonatomic, copy) UAIAMGetUserRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAIAMGetUserRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
