//
//  UAIAMGetServerCertificateRequest.h
//  AWS iOS SDK
//
...
@class UAIAMGetServerCertificateResponse;

typedef void(^UAIAMGetServerCertificateRequestCompletionBlock)(UAIAMGetServerCertificateResponse *response, NSError *error);
typedef BOOL(^UAIAMGetServerCertificateRequestShouldContinueWaitingBlock)(UAIAMGetServerCertificateResponse *response, NSError *error);

@interface UAIAMGetServerCertificateRequest : UAIAMRequest

@property (nonatomic, copy) NSString *serverCertificateName;
// @property (nonatomic, copy) UAIAMGetServerCertificateRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAIAMGetServerCertificateRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
