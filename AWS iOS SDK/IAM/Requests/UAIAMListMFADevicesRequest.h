...
@class UAIAMListMFADevicesResponse;

typedef void(^UAIAMListMFADevicesRequestCompletionBlock)(UAIAMListMFADevicesResponse *response, NSError *error);
typedef BOOL(^UAIAMListMFADevicesRequestShouldContinueWaitingBlock)(UAIAMListMFADevicesResponse *response, NSError *error);

@interface UAIAMListMFADevicesRequest : UAIAMRequest

@property (nonatomic, copy) NSString *userName;
@property (nonatomic, copy) NSString *marker;
@property (nonatomic, strong) NSNumber *maxItems;
// @property (nonatomic, copy) UAIAMListMFADevicesRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAIAMListMFADevicesRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
