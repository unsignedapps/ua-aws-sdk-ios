//
//  UAIAMUploadServerCertificateRequest.h
//  AWS iOS SDK
//
...
@class UAIAMUploadServerCertificateResponse;

typedef void(^UAIAMUploadServerCertificateRequestCompletionBlock)(UAIAMUploadServerCertificateResponse *response, NSError *error);
typedef BOOL(^UAIAMUploadServerCertificateRequestShouldContinueWaitingBlock)(UAIAMUploadServerCertificateResponse *response, NSError *error);

@interface UAIAMUploadServerCertificateRequest : UAIAMRequest
...
// @property (nonatomic, copy) UAIAMUploadServerCertificateRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAIAMUploadServerCertificateRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
