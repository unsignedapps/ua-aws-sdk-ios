//
//  UAIAMDeleteRolePolicyRequest.m
//  AWS iOS SDK
//
...
@interface UAIAMDeleteRolePolicyRequest ()
...
@implementation UAIAMDeleteRolePolicyRequest
...
- (id)init
{
	if (self = [super init])
	{
		[self setAction:@"DeleteRolePolicy"];
...
{
	return [UAIAMDeleteRolePolicyResponse class];
}
