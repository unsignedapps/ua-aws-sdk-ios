...
@class UAIAMPutRolePolicyResponse;

typedef void(^UAIAMPutRolePolicyRequestCompletionBlock)(UAIAMPutRolePolicyResponse *response, NSError *error);
typedef BOOL(^UAIAMPutRolePolicyRequestShouldContinueWaitingBlock)(UAIAMPutRolePolicyResponse *response, NSError *error);

@interface UAIAMPutRolePolicyRequest : UAIAMRequest

@property (nonatomic, copy) NSString *roleName;
@property (nonatomic, copy) NSString *policyName;
@property (nonatomic, copy) NSString *policyDocument;
// @property (nonatomic, copy) UAIAMPutRolePolicyRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAIAMPutRolePolicyRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
