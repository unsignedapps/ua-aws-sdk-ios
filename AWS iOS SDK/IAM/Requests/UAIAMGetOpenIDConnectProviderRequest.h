//
//  UAIAMGetOpenIDConnectProviderRequest.h
//  AWS iOS SDK
//
...
@class UAIAMGetOpenIDConnectProviderResponse;

typedef void(^UAIAMGetOpenIDConnectProviderRequestCompletionBlock)(UAIAMGetOpenIDConnectProviderResponse *response, NSError *error);
typedef BOOL(^UAIAMGetOpenIDConnectProviderRequestShouldContinueWaitingBlock)(UAIAMGetOpenIDConnectProviderResponse *response, NSError *error);

@interface UAIAMGetOpenIDConnectProviderRequest : UAIAMRequest

@property (nonatomic, copy) NSString *openIDConnectProviderARN;
// @property (nonatomic, copy) UAIAMGetOpenIDConnectProviderRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAIAMGetOpenIDConnectProviderRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
