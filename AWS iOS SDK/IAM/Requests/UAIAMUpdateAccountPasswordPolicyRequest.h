//
//  UAIAMUpdateAccountPasswordPolicyRequest.h
//  AWS iOS SDK
//
...
@class UAIAMUpdateAccountPasswordPolicyResponse;

typedef void(^UAIAMUpdateAccountPasswordPolicyRequestCompletionBlock)(UAIAMUpdateAccountPasswordPolicyResponse *response, NSError *error);
typedef BOOL(^UAIAMUpdateAccountPasswordPolicyRequestShouldContinueWaitingBlock)(UAIAMUpdateAccountPasswordPolicyResponse *response, NSError *error);

@interface UAIAMUpdateAccountPasswordPolicyRequest : UAIAMRequest
