...
@class UAIAMDeleteRoleResponse;

typedef void(^UAIAMDeleteRoleRequestCompletionBlock)(UAIAMDeleteRoleResponse *response, NSError *error);
typedef BOOL(^UAIAMDeleteRoleRequestShouldContinueWaitingBlock)(UAIAMDeleteRoleResponse *response, NSError *error);

@interface UAIAMDeleteRoleRequest : UAIAMRequest

@property (nonatomic, copy) NSString *roleName;
// @property (nonatomic, copy) UAIAMDeleteRoleRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAIAMDeleteRoleRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
