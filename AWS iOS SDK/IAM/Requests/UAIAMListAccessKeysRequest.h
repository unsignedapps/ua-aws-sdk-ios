...
@class UAIAMListAccessKeysResponse;

typedef void(^UAIAMListAccessKeysRequestCompletionBlock)(UAIAMListAccessKeysResponse *response, NSError *error);
typedef BOOL(^UAIAMListAccessKeysRequestShouldContinueWaitingBlock)(UAIAMListAccessKeysResponse *response, NSError *error);

@interface UAIAMListAccessKeysRequest : UAIAMRequest

@property (nonatomic, copy) NSString *userName;
@property (nonatomic, copy) NSString *marker;
@property (nonatomic, strong) NSNumber *maxItems;
// @property (nonatomic, copy) UAIAMListAccessKeysRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAIAMListAccessKeysRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
