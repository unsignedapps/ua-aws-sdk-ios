...
@class UAIAMCreateRoleResponse;

typedef void(^UAIAMCreateRoleRequestCompletionBlock)(UAIAMCreateRoleResponse *response, NSError *error);
typedef BOOL(^UAIAMCreateRoleRequestShouldContinueWaitingBlock)(UAIAMCreateRoleResponse *response, NSError *error);

@interface UAIAMCreateRoleRequest : UAIAMRequest

@property (nonatomic, copy) NSString *path;
@property (nonatomic, copy) NSString *roleName;
@property (nonatomic, copy) NSString *assumeRolePolicyDocument;
// @property (nonatomic, copy) UAIAMCreateRoleRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAIAMCreateRoleRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
