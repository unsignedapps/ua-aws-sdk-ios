//
//  UAIAMCreateLoginProfileRequest.h
//  AWS iOS SDK
//
...
@class UAIAMCreateLoginProfileResponse;

typedef void(^UAIAMCreateLoginProfileRequestCompletionBlock)(UAIAMCreateLoginProfileResponse *response, NSError *error);
typedef BOOL(^UAIAMCreateLoginProfileRequestShouldContinueWaitingBlock)(UAIAMCreateLoginProfileResponse *response, NSError *error);

@interface UAIAMCreateLoginProfileRequest : UAIAMRequest
