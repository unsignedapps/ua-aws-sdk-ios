...
@class UAIAMGetRoleResponse;

typedef void(^UAIAMGetRoleRequestCompletionBlock)(UAIAMGetRoleResponse *response, NSError *error);
typedef BOOL(^UAIAMGetRoleRequestShouldContinueWaitingBlock)(UAIAMGetRoleResponse *response, NSError *error);

@interface UAIAMGetRoleRequest : UAIAMRequest

@property (nonatomic, copy) NSString *roleName;
// @property (nonatomic, copy) UAIAMGetRoleRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAIAMGetRoleRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
