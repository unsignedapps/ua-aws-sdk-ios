//
//  UAIAMUpdateSAMLProviderRequest.h
//  AWS iOS SDK
//
...
@class UAIAMUpdateSAMLProviderResponse;

typedef void(^UAIAMUpdateSAMLProviderRequestCompletionBlock)(UAIAMUpdateSAMLProviderResponse *response, NSError *error);
typedef BOOL(^UAIAMUpdateSAMLProviderRequestShouldContinueWaitingBlock)(UAIAMUpdateSAMLProviderResponse *response, NSError *error);

@interface UAIAMUpdateSAMLProviderRequest : UAIAMRequest

@property (nonatomic, copy) NSString *sAMLMetadataDocument;
@property (nonatomic, copy) NSString *sAMLProviderARN;
// @property (nonatomic, copy) UAIAMUpdateSAMLProviderRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAIAMUpdateSAMLProviderRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
