...
@class UAIAMGetRolePolicyResponse;

typedef void(^UAIAMGetRolePolicyRequestCompletionBlock)(UAIAMGetRolePolicyResponse *response, NSError *error);
typedef BOOL(^UAIAMGetRolePolicyRequestShouldContinueWaitingBlock)(UAIAMGetRolePolicyResponse *response, NSError *error);

@interface UAIAMGetRolePolicyRequest : UAIAMRequest

@property (nonatomic, copy) NSString *roleName;
@property (nonatomic, copy) NSString *policyName;
// @property (nonatomic, copy) UAIAMGetRolePolicyRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAIAMGetRolePolicyRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
