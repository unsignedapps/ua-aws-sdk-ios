//
//  UAIAMDeleteOpenIDConnectProviderRequest.h
//  AWS iOS SDK
//
...
@class UAIAMDeleteOpenIDConnectProviderResponse;

typedef void(^UAIAMDeleteOpenIDConnectProviderRequestCompletionBlock)(UAIAMDeleteOpenIDConnectProviderResponse *response, NSError *error);
typedef BOOL(^UAIAMDeleteOpenIDConnectProviderRequestShouldContinueWaitingBlock)(UAIAMDeleteOpenIDConnectProviderResponse *response, NSError *error);

@interface UAIAMDeleteOpenIDConnectProviderRequest : UAIAMRequest

@property (nonatomic, copy) NSString *openIDConnectProviderARN;
// @property (nonatomic, copy) UAIAMDeleteOpenIDConnectProviderRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAIAMDeleteOpenIDConnectProviderRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
