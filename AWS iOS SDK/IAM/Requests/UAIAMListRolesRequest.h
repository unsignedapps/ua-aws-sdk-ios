...
@class UAIAMListRolesResponse;

typedef void(^UAIAMListRolesRequestCompletionBlock)(UAIAMListRolesResponse *response, NSError *error);
typedef BOOL(^UAIAMListRolesRequestShouldContinueWaitingBlock)(UAIAMListRolesResponse *response, NSError *error);

@interface UAIAMListRolesRequest : UAIAMRequest

@property (nonatomic, copy) NSString *pathPrefix;
@property (nonatomic, copy) NSString *marker;
@property (nonatomic, strong) NSNumber *maxItems;
// @property (nonatomic, copy) UAIAMListRolesRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAIAMListRolesRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
