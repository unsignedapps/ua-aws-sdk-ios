//
//  UAIAMListRolePoliciesRequest.h
//  AWS iOS SDK
//
...
@class UAIAMListRolePoliciesResponse;

typedef void(^UAIAMListRolePoliciesRequestCompletionBlock)(UAIAMListRolePoliciesResponse *response, NSError *error);
typedef BOOL(^UAIAMListRolePoliciesRequestShouldContinueWaitingBlock)(UAIAMListRolePoliciesResponse *response, NSError *error);

@interface UAIAMListRolePoliciesRequest : UAIAMRequest

@property (nonatomic, copy) NSString *roleName;
@property (nonatomic, copy) NSString *marker;
@property (nonatomic, strong) NSNumber *maxItems;
// @property (nonatomic, copy) UAIAMListRolePoliciesRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAIAMListRolePoliciesRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
