...
@class UAIAMPutGroupPolicyResponse;

typedef void(^UAIAMPutGroupPolicyRequestCompletionBlock)(UAIAMPutGroupPolicyResponse *response, NSError *error);
typedef BOOL(^UAIAMPutGroupPolicyRequestShouldContinueWaitingBlock)(UAIAMPutGroupPolicyResponse *response, NSError *error);

@interface UAIAMPutGroupPolicyRequest : UAIAMRequest

@property (nonatomic, copy) NSString *groupName;
@property (nonatomic, copy) NSString *policyName;
@property (nonatomic, copy) NSString *policyDocument;
// @property (nonatomic, copy) UAIAMPutGroupPolicyRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAIAMPutGroupPolicyRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
