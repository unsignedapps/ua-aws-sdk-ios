...
@class UAIAMUpdateAccessKeyResponse;

typedef void(^UAIAMUpdateAccessKeyRequestCompletionBlock)(UAIAMUpdateAccessKeyResponse *response, NSError *error);
typedef BOOL(^UAIAMUpdateAccessKeyRequestShouldContinueWaitingBlock)(UAIAMUpdateAccessKeyResponse *response, NSError *error);

@interface UAIAMUpdateAccessKeyRequest : UAIAMRequest

@property (nonatomic, copy) NSString *userName;
@property (nonatomic, copy) NSString *accessKeyID;
@property (nonatomic) UAIAMAccessKeyStatus status;
// @property (nonatomic, copy) UAIAMUpdateAccessKeyRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAIAMUpdateAccessKeyRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
