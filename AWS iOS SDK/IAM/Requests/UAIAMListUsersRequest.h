...
@class UAIAMListUsersResponse;

typedef void(^UAIAMListUsersRequestCompletionBlock)(UAIAMListUsersResponse *response, NSError *error);
typedef BOOL(^UAIAMListUsersRequestShouldContinueWaitingBlock)(UAIAMListUsersResponse *response, NSError *error);

@interface UAIAMListUsersRequest : UAIAMRequest

@property (nonatomic, copy) NSString *pathPrefix;
@property (nonatomic, copy) NSString *marker;
@property (nonatomic, strong) NSNumber *maxItems;
// @property (nonatomic, copy) UAIAMListUsersRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAIAMListUsersRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
