//
//  UAIAMCreateSAMLProviderRequest.h
//  AWS iOS SDK
//
...
@class UAIAMCreateSAMLProviderResponse;

typedef void(^UAIAMCreateSAMLProviderRequestCompletionBlock)(UAIAMCreateSAMLProviderResponse *response, NSError *error);
typedef BOOL(^UAIAMCreateSAMLProviderRequestShouldContinueWaitingBlock)(UAIAMCreateSAMLProviderResponse *response, NSError *error);

@interface UAIAMCreateSAMLProviderRequest : UAIAMRequest

@property (nonatomic, copy) NSString *sAMLMetadataDocument;
@property (nonatomic, copy) NSString *name;
// @property (nonatomic, copy) UAIAMCreateSAMLProviderRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAIAMCreateSAMLProviderRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
