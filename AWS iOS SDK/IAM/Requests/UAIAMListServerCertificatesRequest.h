//
//  UAIAMListServerCertificatesRequest.h
//  AWS iOS SDK
//
...
@class UAIAMListServerCertificatesResponse;

typedef void(^UAIAMListServerCertificatesRequestCompletionBlock)(UAIAMListServerCertificatesResponse *response, NSError *error);
typedef BOOL(^UAIAMListServerCertificatesRequestShouldContinueWaitingBlock)(UAIAMListServerCertificatesResponse *response, NSError *error);

@interface UAIAMListServerCertificatesRequest : UAIAMRequest

@property (nonatomic, copy) NSString *pathPrefix;
@property (nonatomic, copy) NSString *marker;
@property (nonatomic, strong) NSNumber *maxItems;
// @property (nonatomic, copy) UAIAMListServerCertificatesRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAIAMListServerCertificatesRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
