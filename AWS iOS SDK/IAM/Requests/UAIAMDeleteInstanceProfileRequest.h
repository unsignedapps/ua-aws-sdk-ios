//
//  UAIAMDeleteInstanceProfileRequest.h
//  AWS iOS SDK
//
...
@class UAIAMDeleteInstanceProfileResponse;

typedef void(^UAIAMDeleteInstanceProfileRequestCompletionBlock)(UAIAMDeleteInstanceProfileResponse *response, NSError *error);
typedef BOOL(^UAIAMDeleteInstanceProfileRequestShouldContinueWaitingBlock)(UAIAMDeleteInstanceProfileResponse *response, NSError *error);

@interface UAIAMDeleteInstanceProfileRequest : UAIAMRequest

@property (nonatomic, copy) NSString *instanceProfileName;
// @property (nonatomic, copy) UAIAMDeleteInstanceProfileRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAIAMDeleteInstanceProfileRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
