...
@class UAIAMChangePasswordResponse;

typedef void(^UAIAMChangePasswordRequestCompletionBlock)(UAIAMChangePasswordResponse *response, NSError *error);
typedef BOOL(^UAIAMChangePasswordRequestShouldContinueWaitingBlock)(UAIAMChangePasswordResponse *response, NSError *error);

@interface UAIAMChangePasswordRequest : UAIAMRequest

@property (nonatomic, copy) NSString *oldPassword;
@property (nonatomic, copy) NSString *changedPassword;
// @property (nonatomic, copy) UAIAMChangePasswordRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAIAMChangePasswordRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
