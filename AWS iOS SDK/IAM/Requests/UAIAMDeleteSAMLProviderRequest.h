//
//  UAIAMDeleteSAMLProviderRequest.h
//  AWS iOS SDK
//
...
@class UAIAMDeleteSAMLProviderResponse;

typedef void(^UAIAMDeleteSAMLProviderRequestCompletionBlock)(UAIAMDeleteSAMLProviderResponse *response, NSError *error);
typedef BOOL(^UAIAMDeleteSAMLProviderRequestShouldContinueWaitingBlock)(UAIAMDeleteSAMLProviderResponse *response, NSError *error);

@interface UAIAMDeleteSAMLProviderRequest : UAIAMRequest

@property (nonatomic, copy) NSString *sAMLProviderARN;
// @property (nonatomic, copy) UAIAMDeleteSAMLProviderRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAIAMDeleteSAMLProviderRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
