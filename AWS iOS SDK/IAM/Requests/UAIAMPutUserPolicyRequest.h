...
@class UAIAMPutUserPolicyResponse;

typedef void(^UAIAMPutUserPolicyRequestCompletionBlock)(UAIAMPutUserPolicyResponse *response, NSError *error);
typedef BOOL(^UAIAMPutUserPolicyRequestShouldContinueWaitingBlock)(UAIAMPutUserPolicyResponse *response, NSError *error);

@interface UAIAMPutUserPolicyRequest : UAIAMRequest

@property (nonatomic, copy) NSString *userName;
@property (nonatomic, copy) NSString *policyName;
@property (nonatomic, copy) NSString *policyDocument;
// @property (nonatomic, copy) UAIAMPutUserPolicyRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAIAMPutUserPolicyRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
