...
@class UAIAMGetGroupPolicyResponse;

typedef void(^UAIAMGetGroupPolicyRequestCompletionBlock)(UAIAMGetGroupPolicyResponse *response, NSError *error);
typedef BOOL(^UAIAMGetGroupPolicyRequestShouldContinueWaitingBlock)(UAIAMGetGroupPolicyResponse *response, NSError *error);

@interface UAIAMGetGroupPolicyRequest : UAIAMRequest

@property (nonatomic, copy) NSString *groupName;
@property (nonatomic, copy) NSString *policyName;
// @property (nonatomic, copy) UAIAMGetGroupPolicyRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAIAMGetGroupPolicyRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
