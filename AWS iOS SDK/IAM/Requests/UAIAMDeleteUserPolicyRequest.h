//
//  UAIAMDeleteUserPolicyRequest.h
//  AWS iOS SDK
//
...
@class UAIAMDeleteUserPolicyResponse;

typedef void(^UAIAMDeleteUserPolicyRequestCompletionBlock)(UAIAMDeleteUserPolicyResponse *response, NSError *error);
typedef BOOL(^UAIAMDeleteUserPolicyRequestShouldContinueWaitingBlock)(UAIAMDeleteUserPolicyResponse *response, NSError *error);

@interface UAIAMDeleteUserPolicyRequest : UAIAMRequest

@property (nonatomic, copy) NSString *userName;
@property (nonatomic, copy) NSString *policyName;
// @property (nonatomic, copy) UAIAMDeleteUserPolicyRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAIAMDeleteUserPolicyRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
