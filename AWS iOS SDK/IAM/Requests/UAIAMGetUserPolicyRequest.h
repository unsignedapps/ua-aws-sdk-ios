...
@class UAIAMGetUserPolicyResponse;

typedef void(^UAIAMGetUserPolicyRequestCompletionBlock)(UAIAMGetUserPolicyResponse *response, NSError *error);
typedef BOOL(^UAIAMGetUserPolicyRequestShouldContinueWaitingBlock)(UAIAMGetUserPolicyResponse *response, NSError *error);

@interface UAIAMGetUserPolicyRequest : UAIAMRequest

@property (nonatomic, copy) NSString *userName;
@property (nonatomic, copy) NSString *policyName;
// @property (nonatomic, copy) UAIAMGetUserPolicyRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAIAMGetUserPolicyRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
