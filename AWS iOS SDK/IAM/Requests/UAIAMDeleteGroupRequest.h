...
@class UAIAMDeleteGroupResponse;

typedef void(^UAIAMDeleteGroupRequestCompletionBlock)(UAIAMDeleteGroupResponse *response, NSError *error);
typedef BOOL(^UAIAMDeleteGroupRequestShouldContinueWaitingBlock)(UAIAMDeleteGroupResponse *response, NSError *error);

@interface UAIAMDeleteGroupRequest : UAIAMRequest

@property (nonatomic, copy) NSString *groupName;
// @property (nonatomic, copy) UAIAMDeleteGroupRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAIAMDeleteGroupRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
