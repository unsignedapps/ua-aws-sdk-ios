//
//  UAIAMListUserPoliciesRequest.h
//  AWS iOS SDK
//
...
@class UAIAMListUserPoliciesResponse;

typedef void(^UAIAMListUserPoliciesRequestCompletionBlock)(UAIAMListUserPoliciesResponse *response, NSError *error);
typedef BOOL(^UAIAMListUserPoliciesRequestShouldContinueWaitingBlock)(UAIAMListUserPoliciesResponse *response, NSError *error);

@interface UAIAMListUserPoliciesRequest : UAIAMRequest

@property (nonatomic, copy) NSString *userName;
@property (nonatomic, copy) NSString *marker;
@property (nonatomic, strong) NSNumber *maxItems;
// @property (nonatomic, copy) UAIAMListUserPoliciesRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAIAMListUserPoliciesRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
