//
//  UAIAMDeleteServerCertificateRequest.h
//  AWS iOS SDK
//
...
@class UAIAMDeleteServerCertificateResponse;

typedef void(^UAIAMDeleteServerCertificateRequestCompletionBlock)(UAIAMDeleteServerCertificateResponse *response, NSError *error);
typedef BOOL(^UAIAMDeleteServerCertificateRequestShouldContinueWaitingBlock)(UAIAMDeleteServerCertificateResponse *response, NSError *error);

@interface UAIAMDeleteServerCertificateRequest : UAIAMRequest

@property (nonatomic, copy) NSString *serverCertificateName;
// @property (nonatomic, copy) UAIAMDeleteServerCertificateRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAIAMDeleteServerCertificateRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
