...
@class UADDBBatchWriteItemResponse;

typedef void(^UADDBBatchWriteItemRequestCompletionBlock)(UADDBBatchWriteItemResponse *response, NSError *error);
typedef BOOL(^UADDBBatchWriteItemRequestShouldContinueWaitingBlock)(UADDBBatchWriteItemResponse *response, NSError *error);

@interface UADDBBatchWriteItemRequest : UADDBRequest
...
// @property (nonatomic, copy) UADDBBatchWriteItemRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UADDBBatchWriteItemRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;

/**
 * Retrieves the NSMutableArray for the specified TableName.
**/
