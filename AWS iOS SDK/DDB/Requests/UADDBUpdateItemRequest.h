...
@class UADDBAttributeUpdate, UADDBExpectedItem, UADDBUpdateItemResponse;

typedef void(^UADDBUpdateItemRequestCompletionBlock)(UADDBUpdateItemResponse *response, NSError *error);
typedef BOOL(^UADDBUpdateItemRequestShouldContinueWaitingBlock)(UADDBUpdateItemResponse *response, NSError *error);

@interface UADDBUpdateItemRequest : UADDBRequest
...
// @property (nonatomic, copy) UADDBUpdateItemRequestCompletionBlock UA_RequestCompletionBlock;
...
/**
 * Adds a AttributeUpdate to the attributeUpdates property.
 *
