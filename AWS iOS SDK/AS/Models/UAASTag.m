...
{
    return [NSValueTransformer UA_ENUMTransformerWithValues:@[ @(UAASTagResourceTypeAutoScalingGroup) ]
                                               stringValues:@[ @"auto-scaling-group" ]
                                               unknownValue:@(UAASTagResourceTypeUnknown)];
}
