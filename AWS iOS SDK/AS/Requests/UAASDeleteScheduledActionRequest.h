//
//  UAASDeleteScheduledActionRequest.h
//  AWS iOS SDK
//
...
@class UAASDeleteScheduledActionResponse;

typedef void(^UAASDeleteScheduledActionRequestCompletionBlock)(UAASDeleteScheduledActionResponse *response, NSError *error);
typedef BOOL(^UAASDeleteScheduledActionRequestShouldContinueWaitingBlock)(UAASDeleteScheduledActionResponse *response, NSError *error);

@interface UAASDeleteScheduledActionRequest : UAASRequest

@property (nonatomic, copy) NSString *autoScalingGroupName;
@property (nonatomic, copy) NSString *scheduledActionName;
// @property (nonatomic, copy) UAASDeleteScheduledActionRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAASDeleteScheduledActionRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
