...
@class UAASFilter, UAASDescribeTagsResponse;

typedef void(^UAASDescribeTagsRequestCompletionBlock)(UAASDescribeTagsResponse *response, NSError *error);
typedef BOOL(^UAASDescribeTagsRequestShouldContinueWaitingBlock)(UAASDescribeTagsResponse *response, NSError *error);

@interface UAASDescribeTagsRequest : UAASRequest

@property (nonatomic, strong) NSMutableArray *filters;
@property (nonatomic, copy) NSString *nextToken;
@property (nonatomic, strong) NSNumber *maxRecords;
// @property (nonatomic, copy) UAASDescribeTagsRequestCompletionBlock UA_RequestCompletionBlock;
