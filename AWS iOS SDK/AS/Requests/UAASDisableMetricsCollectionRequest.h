//
//  UAASDisableMetricsCollectionRequest.h
//  AWS iOS SDK
//
...
@class UAASDisableMetricsCollectionResponse;

typedef void(^UAASDisableMetricsCollectionRequestCompletionBlock)(UAASDisableMetricsCollectionResponse *response, NSError *error);
typedef BOOL(^UAASDisableMetricsCollectionRequestShouldContinueWaitingBlock)(UAASDisableMetricsCollectionResponse *response, NSError *error);

@interface UAASDisableMetricsCollectionRequest : UAASRequest

@property (nonatomic, copy) NSString *autoScalingGroupName;
@property (nonatomic, strong) NSMutableArray *metrics;
// @property (nonatomic, copy) UAASDisableMetricsCollectionRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAASDisableMetricsCollectionRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
