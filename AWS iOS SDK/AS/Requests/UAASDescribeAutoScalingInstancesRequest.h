//
//  UAASDescribeAutoScalingInstancesRequest.h
//  AWS iOS SDK
//
...
@class UAASDescribeAutoScalingInstancesResponse;

typedef void(^UAASDescribeAutoScalingInstancesRequestCompletionBlock)(UAASDescribeAutoScalingInstancesResponse *response, NSError *error);
typedef BOOL(^UAASDescribeAutoScalingInstancesRequestShouldContinueWaitingBlock)(UAASDescribeAutoScalingInstancesResponse *response, NSError *error);

@interface UAASDescribeAutoScalingInstancesRequest : UAASRequest

@property (nonatomic, strong) NSMutableArray *instanceIDs;
@property (nonatomic, strong) NSNumber *maxRecords;
@property (nonatomic, copy) NSString *nextToken;
// @property (nonatomic, copy) UAASDescribeAutoScalingInstancesRequestCompletionBlock UA_RequestCompletionBlock;
