//
//  UAASDeleteLaunchConfigurationRequest.h
//  AWS iOS SDK
//
...
@class UAASDeleteLaunchConfigurationResponse;

typedef void(^UAASDeleteLaunchConfigurationRequestCompletionBlock)(UAASDeleteLaunchConfigurationResponse *response, NSError *error);
typedef BOOL(^UAASDeleteLaunchConfigurationRequestShouldContinueWaitingBlock)(UAASDeleteLaunchConfigurationResponse *response, NSError *error);

@interface UAASDeleteLaunchConfigurationRequest : UAASRequest

@property (nonatomic, copy) NSString *launchConfigurationName;
// @property (nonatomic, copy) UAASDeleteLaunchConfigurationRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAASDeleteLaunchConfigurationRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
