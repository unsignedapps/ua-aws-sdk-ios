...
@class UAASTag, UAASCreateOrUpdateTagsResponse;

typedef void(^UAASCreateOrUpdateTagsRequestCompletionBlock)(UAASCreateOrUpdateTagsResponse *response, NSError *error);
typedef BOOL(^UAASCreateOrUpdateTagsRequestShouldContinueWaitingBlock)(UAASCreateOrUpdateTagsResponse *response, NSError *error);

@interface UAASCreateOrUpdateTagsRequest : UAASRequest

@property (nonatomic, strong) NSMutableArray *tags;
// @property (nonatomic, copy) UAASCreateOrUpdateTagsRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAASCreateOrUpdateTagsRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
