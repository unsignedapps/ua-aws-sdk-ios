...
- (void)setLaunchConfigurationNames:(NSMutableArray *)launchConfigurationNames
{
	_launchConfigurationNames = launchConfigurationNames;
	
	if (![self.UA_dirtyProperties containsObject:@"launchConfigurationNames"])
		[self.UA_dirtyProperties addObject:@"launchConfigurationNames"];
}
