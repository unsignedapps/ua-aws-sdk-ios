...
@class UAASExecutePolicyResponse;

typedef void(^UAASExecutePolicyRequestCompletionBlock)(UAASExecutePolicyResponse *response, NSError *error);
typedef BOOL(^UAASExecutePolicyRequestShouldContinueWaitingBlock)(UAASExecutePolicyResponse *response, NSError *error);

@interface UAASExecutePolicyRequest : UAASRequest
...
// @property (nonatomic, copy) UAASExecutePolicyRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAASExecutePolicyRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
