//
//  UAASDeleteLifecycleHookRequest.h
//  AWS iOS SDK
//
...
@class UAASDeleteLifecycleHookResponse;

typedef void(^UAASDeleteLifecycleHookRequestCompletionBlock)(UAASDeleteLifecycleHookResponse *response, NSError *error);
typedef BOOL(^UAASDeleteLifecycleHookRequestShouldContinueWaitingBlock)(UAASDeleteLifecycleHookResponse *response, NSError *error);

@interface UAASDeleteLifecycleHookRequest : UAASRequest

@property (nonatomic, copy) NSString *lifecycleHookName;
@property (nonatomic, copy) NSString *autoScalingGroupName;
// @property (nonatomic, copy) UAASDeleteLifecycleHookRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAASDeleteLifecycleHookRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
