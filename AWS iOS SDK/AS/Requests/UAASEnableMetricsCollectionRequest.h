//
//  UAASEnableMetricsCollectionRequest.h
//  AWS iOS SDK
//
...
@class UAASEnableMetricsCollectionResponse;

typedef void(^UAASEnableMetricsCollectionRequestCompletionBlock)(UAASEnableMetricsCollectionResponse *response, NSError *error);
typedef BOOL(^UAASEnableMetricsCollectionRequestShouldContinueWaitingBlock)(UAASEnableMetricsCollectionResponse *response, NSError *error);

@interface UAASEnableMetricsCollectionRequest : UAASRequest
...
// @property (nonatomic, copy) UAASEnableMetricsCollectionRequestCompletionBlock UA_RequestCompletionBlock;
