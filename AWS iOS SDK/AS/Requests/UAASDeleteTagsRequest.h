...
@class UAASTag, UAASDeleteTagsResponse;

typedef void(^UAASDeleteTagsRequestCompletionBlock)(UAASDeleteTagsResponse *response, NSError *error);
typedef BOOL(^UAASDeleteTagsRequestShouldContinueWaitingBlock)(UAASDeleteTagsResponse *response, NSError *error);

@interface UAASDeleteTagsRequest : UAASRequest

@property (nonatomic, strong) NSMutableArray *tags;
// @property (nonatomic, copy) UAASDeleteTagsRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAASDeleteTagsRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
