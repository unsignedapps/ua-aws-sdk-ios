...
@class UAASExitStandbyResponse;

typedef void(^UAASExitStandbyRequestCompletionBlock)(UAASExitStandbyResponse *response, NSError *error);
typedef BOOL(^UAASExitStandbyRequestShouldContinueWaitingBlock)(UAASExitStandbyResponse *response, NSError *error);

@interface UAASExitStandbyRequest : UAASRequest

@property (nonatomic, strong) NSMutableArray *instanceIDs;
@property (nonatomic, copy) NSString *autoScalingGroupName;
// @property (nonatomic, copy) UAASExitStandbyRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAASExitStandbyRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
