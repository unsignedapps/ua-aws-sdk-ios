...
@class UAASDeletePolicyResponse;

typedef void(^UAASDeletePolicyRequestCompletionBlock)(UAASDeletePolicyResponse *response, NSError *error);
typedef BOOL(^UAASDeletePolicyRequestShouldContinueWaitingBlock)(UAASDeletePolicyResponse *response, NSError *error);

@interface UAASDeletePolicyRequest : UAASRequest

@property (nonatomic, copy) NSString *autoScalingGroupName;
@property (nonatomic, copy) NSString *policyName;
// @property (nonatomic, copy) UAASDeletePolicyRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAASDeletePolicyRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
