//
//  UAASDescribeAutoScalingGroupsRequest.h
//  AWS iOS SDK
//
...
@class UAASDescribeAutoScalingGroupsResponse;

typedef void(^UAASDescribeAutoScalingGroupsRequestCompletionBlock)(UAASDescribeAutoScalingGroupsResponse *response, NSError *error);
typedef BOOL(^UAASDescribeAutoScalingGroupsRequestShouldContinueWaitingBlock)(UAASDescribeAutoScalingGroupsResponse *response, NSError *error);

@interface UAASDescribeAutoScalingGroupsRequest : UAASRequest

@property (nonatomic, strong) NSMutableArray *autoScalingGroupNames;
@property (nonatomic, copy) NSString *nextToken;
@property (nonatomic, strong) NSNumber *maxRecords;
// @property (nonatomic, copy) UAASDescribeAutoScalingGroupsRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAASDescribeAutoScalingGroupsRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
