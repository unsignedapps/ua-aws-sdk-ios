//
//  UAASSetDesiredCapacityRequest.h
//  AWS iOS SDK
//
...
@class UAASSetDesiredCapacityResponse;

typedef void(^UAASSetDesiredCapacityRequestCompletionBlock)(UAASSetDesiredCapacityResponse *response, NSError *error);
typedef BOOL(^UAASSetDesiredCapacityRequestShouldContinueWaitingBlock)(UAASSetDesiredCapacityResponse *response, NSError *error);

@interface UAASSetDesiredCapacityRequest : UAASRequest
...
// @property (nonatomic, copy) UAASSetDesiredCapacityRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAASSetDesiredCapacityRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
