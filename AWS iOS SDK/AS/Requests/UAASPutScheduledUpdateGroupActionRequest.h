//
//  UAASPutScheduledUpdateGroupActionRequest.h
//  AWS iOS SDK
//
...
@class UAASPutScheduledUpdateGroupActionResponse;

typedef void(^UAASPutScheduledUpdateGroupActionRequestCompletionBlock)(UAASPutScheduledUpdateGroupActionResponse *response, NSError *error);
typedef BOOL(^UAASPutScheduledUpdateGroupActionRequestShouldContinueWaitingBlock)(UAASPutScheduledUpdateGroupActionResponse *response, NSError *error);

@interface UAASPutScheduledUpdateGroupActionRequest : UAASRequest
...
// @property (nonatomic, copy) UAASPutScheduledUpdateGroupActionRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAASPutScheduledUpdateGroupActionRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
