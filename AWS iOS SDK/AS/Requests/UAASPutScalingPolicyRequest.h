...
@class UAASPutScalingPolicyResponse;

typedef void(^UAASPutScalingPolicyRequestCompletionBlock)(UAASPutScalingPolicyResponse *response, NSError *error);
typedef BOOL(^UAASPutScalingPolicyRequestShouldContinueWaitingBlock)(UAASPutScalingPolicyResponse *response, NSError *error);

@interface UAASPutScalingPolicyRequest : UAASRequest
...
// @property (nonatomic, copy) UAASPutScalingPolicyRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAASPutScalingPolicyRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
