//
//  UAASDescribeNotificationConfigurationsRequest.h
//  AWS iOS SDK
//
...
@class UAASDescribeNotificationConfigurationsResponse;

typedef void(^UAASDescribeNotificationConfigurationsRequestCompletionBlock)(UAASDescribeNotificationConfigurationsResponse *response, NSError *error);
typedef BOOL(^UAASDescribeNotificationConfigurationsRequestShouldContinueWaitingBlock)(UAASDescribeNotificationConfigurationsResponse *response, NSError *error);

@interface UAASDescribeNotificationConfigurationsRequest : UAASRequest

@property (nonatomic, strong) NSMutableArray *autoScalingGroupNames;
@property (nonatomic, copy) NSString *nextToken;
@property (nonatomic, strong) NSNumber *maxRecords;
// @property (nonatomic, copy) UAASDescribeNotificationConfigurationsRequestCompletionBlock UA_RequestCompletionBlock;
