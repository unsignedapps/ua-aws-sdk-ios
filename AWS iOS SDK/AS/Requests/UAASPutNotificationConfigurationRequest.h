//
//  UAASPutNotificationConfigurationRequest.h
//  AWS iOS SDK
//
...
@class UAASPutNotificationConfigurationResponse;

typedef void(^UAASPutNotificationConfigurationRequestCompletionBlock)(UAASPutNotificationConfigurationResponse *response, NSError *error);
typedef BOOL(^UAASPutNotificationConfigurationRequestShouldContinueWaitingBlock)(UAASPutNotificationConfigurationResponse *response, NSError *error);

@interface UAASPutNotificationConfigurationRequest : UAASRequest
...
// @property (nonatomic, copy) UAASPutNotificationConfigurationRequestCompletionBlock UA_RequestCompletionBlock;
