//
//  UAASDeleteAutoScalingGroupRequest.h
//  AWS iOS SDK
//
...
@class UAASDeleteAutoScalingGroupResponse;

typedef void(^UAASDeleteAutoScalingGroupRequestCompletionBlock)(UAASDeleteAutoScalingGroupResponse *response, NSError *error);
typedef BOOL(^UAASDeleteAutoScalingGroupRequestShouldContinueWaitingBlock)(UAASDeleteAutoScalingGroupResponse *response, NSError *error);

@interface UAASDeleteAutoScalingGroupRequest : UAASRequest

@property (nonatomic, copy) NSString *autoScalingGroupName;
@property (nonatomic) BOOL forceDelete;
// @property (nonatomic, copy) UAASDeleteAutoScalingGroupRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAASDeleteAutoScalingGroupRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
