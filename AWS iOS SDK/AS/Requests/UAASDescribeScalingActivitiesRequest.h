//
//  UAASDescribeScalingActivitiesRequest.h
//  AWS iOS SDK
//
...
@class UAASDescribeScalingActivitiesResponse;

typedef void(^UAASDescribeScalingActivitiesRequestCompletionBlock)(UAASDescribeScalingActivitiesResponse *response, NSError *error);
typedef BOOL(^UAASDescribeScalingActivitiesRequestShouldContinueWaitingBlock)(UAASDescribeScalingActivitiesResponse *response, NSError *error);

@interface UAASDescribeScalingActivitiesRequest : UAASRequest
...
// @property (nonatomic, copy) UAASDescribeScalingActivitiesRequestCompletionBlock UA_RequestCompletionBlock;
