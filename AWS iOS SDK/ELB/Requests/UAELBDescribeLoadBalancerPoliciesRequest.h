//
//  UAELBDescribeLoadBalancerPoliciesRequest.h
//  AWS iOS SDK
//
...
@class UAELBDescribeLoadBalancerPoliciesResponse;

typedef void(^UAELBDescribeLoadBalancerPoliciesRequestCompletionBlock)(UAELBDescribeLoadBalancerPoliciesResponse *response, NSError *error);
typedef BOOL(^UAELBDescribeLoadBalancerPoliciesRequestShouldContinueWaitingBlock)(UAELBDescribeLoadBalancerPoliciesResponse *response, NSError *error);

@interface UAELBDescribeLoadBalancerPoliciesRequest : UAELBRequest

@property (nonatomic, copy) NSString *loadBalancerName;
@property (nonatomic, strong) NSMutableArray *policyNames;
// @property (nonatomic, copy) UAELBDescribeLoadBalancerPoliciesRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAELBDescribeLoadBalancerPoliciesRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
