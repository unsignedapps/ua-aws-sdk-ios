//
//  UAELBCreateLoadBalancerListenersRequest.h
//  AWS iOS SDK
//
...
@class UAELBListener, UAELBCreateLoadBalancerListenersResponse;

typedef void(^UAELBCreateLoadBalancerListenersRequestCompletionBlock)(UAELBCreateLoadBalancerListenersResponse *response, NSError *error);
typedef BOOL(^UAELBCreateLoadBalancerListenersRequestShouldContinueWaitingBlock)(UAELBCreateLoadBalancerListenersResponse *response, NSError *error);

@interface UAELBCreateLoadBalancerListenersRequest : UAELBRequest

@property (nonatomic, copy) NSString *loadBalancerName;
@property (nonatomic, strong) NSMutableArray *listeners;
// @property (nonatomic, copy) UAELBCreateLoadBalancerListenersRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAELBCreateLoadBalancerListenersRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
