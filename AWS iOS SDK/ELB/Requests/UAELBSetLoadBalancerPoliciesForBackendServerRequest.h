//
//  UAELBSetLoadBalancerPoliciesForBackendServerRequest.h
//  AWS iOS SDK
//
...
@class UAELBSetLoadBalancerPoliciesForBackendServerResponse;

typedef void(^UAELBSetLoadBalancerPoliciesForBackendServerRequestCompletionBlock)(UAELBSetLoadBalancerPoliciesForBackendServerResponse *response, NSError *error);
typedef BOOL(^UAELBSetLoadBalancerPoliciesForBackendServerRequestShouldContinueWaitingBlock)(UAELBSetLoadBalancerPoliciesForBackendServerResponse *response, NSError *error);

@interface UAELBSetLoadBalancerPoliciesForBackendServerRequest : UAELBRequest
...
// @property (nonatomic, copy) UAELBSetLoadBalancerPoliciesForBackendServerRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAELBSetLoadBalancerPoliciesForBackendServerRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
