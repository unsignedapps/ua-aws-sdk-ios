//
//  UAELBDescribeInstanceHealthRequest.h
//  AWS iOS SDK
//
...
@class UAELBInstance, UAELBDescribeInstanceHealthResponse;

typedef void(^UAELBDescribeInstanceHealthRequestCompletionBlock)(UAELBDescribeInstanceHealthResponse *response, NSError *error);
typedef BOOL(^UAELBDescribeInstanceHealthRequestShouldContinueWaitingBlock)(UAELBDescribeInstanceHealthResponse *response, NSError *error);

@interface UAELBDescribeInstanceHealthRequest : UAELBRequest

@property (nonatomic, copy) NSString *loadBalancerName;
@property (nonatomic, strong) NSMutableArray *instances;
// @property (nonatomic, copy) UAELBDescribeInstanceHealthRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAELBDescribeInstanceHealthRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
