//
//  UAELBCreateAppCookieStickinessPolicyRequest.h
//  AWS iOS SDK
//
...
@class UAELBCreateAppCookieStickinessPolicyResponse;

typedef void(^UAELBCreateAppCookieStickinessPolicyRequestCompletionBlock)(UAELBCreateAppCookieStickinessPolicyResponse *response, NSError *error);
typedef BOOL(^UAELBCreateAppCookieStickinessPolicyRequestShouldContinueWaitingBlock)(UAELBCreateAppCookieStickinessPolicyResponse *response, NSError *error);

@interface UAELBCreateAppCookieStickinessPolicyRequest : UAELBRequest
...
// @property (nonatomic, copy) UAELBCreateAppCookieStickinessPolicyRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAELBCreateAppCookieStickinessPolicyRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
