//
//  UAELBSetLoadBalancerListenerSSLCertificateRequest.h
//  AWS iOS SDK
//
...
@class UAELBSetLoadBalancerListenerSSLCertificateResponse;

typedef void(^UAELBSetLoadBalancerListenerSSLCertificateRequestCompletionBlock)(UAELBSetLoadBalancerListenerSSLCertificateResponse *response, NSError *error);
typedef BOOL(^UAELBSetLoadBalancerListenerSSLCertificateRequestShouldContinueWaitingBlock)(UAELBSetLoadBalancerListenerSSLCertificateResponse *response, NSError *error);

@interface UAELBSetLoadBalancerListenerSSLCertificateRequest : UAELBRequest
...
// @property (nonatomic, copy) UAELBSetLoadBalancerListenerSSLCertificateRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAELBSetLoadBalancerListenerSSLCertificateRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
