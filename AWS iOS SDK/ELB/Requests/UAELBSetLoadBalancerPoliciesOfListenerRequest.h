//
//  UAELBSetLoadBalancerPoliciesOfListenerRequest.h
//  AWS iOS SDK
//
...
@class UAELBSetLoadBalancerPoliciesOfListenerResponse;

typedef void(^UAELBSetLoadBalancerPoliciesOfListenerRequestCompletionBlock)(UAELBSetLoadBalancerPoliciesOfListenerResponse *response, NSError *error);
typedef BOOL(^UAELBSetLoadBalancerPoliciesOfListenerRequestShouldContinueWaitingBlock)(UAELBSetLoadBalancerPoliciesOfListenerResponse *response, NSError *error);

@interface UAELBSetLoadBalancerPoliciesOfListenerRequest : UAELBRequest
...
// @property (nonatomic, copy) UAELBSetLoadBalancerPoliciesOfListenerRequestCompletionBlock UA_RequestCompletionBlock;
