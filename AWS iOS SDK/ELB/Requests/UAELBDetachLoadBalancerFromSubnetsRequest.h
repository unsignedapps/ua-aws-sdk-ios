//
//  UAELBDetachLoadBalancerFromSubnetsRequest.h
//  AWS iOS SDK
//
...
@class UAELBDetachLoadBalancerFromSubnetsResponse;

typedef void(^UAELBDetachLoadBalancerFromSubnetsRequestCompletionBlock)(UAELBDetachLoadBalancerFromSubnetsResponse *response, NSError *error);
typedef BOOL(^UAELBDetachLoadBalancerFromSubnetsRequestShouldContinueWaitingBlock)(UAELBDetachLoadBalancerFromSubnetsResponse *response, NSError *error);

@interface UAELBDetachLoadBalancerFromSubnetsRequest : UAELBRequest

@property (nonatomic, copy) NSString *loadBalancerName;
@property (nonatomic, strong) NSMutableArray *subnets;
// @property (nonatomic, copy) UAELBDetachLoadBalancerFromSubnetsRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAELBDetachLoadBalancerFromSubnetsRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
