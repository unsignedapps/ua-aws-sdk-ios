//
//  UAELBAttachLoadBalancerToSubnetsRequest.h
//  AWS iOS SDK
//
...
@class UAELBAttachLoadBalancerToSubnetsResponse;

typedef void(^UAELBAttachLoadBalancerToSubnetsRequestCompletionBlock)(UAELBAttachLoadBalancerToSubnetsResponse *response, NSError *error);
typedef BOOL(^UAELBAttachLoadBalancerToSubnetsRequestShouldContinueWaitingBlock)(UAELBAttachLoadBalancerToSubnetsResponse *response, NSError *error);

@interface UAELBAttachLoadBalancerToSubnetsRequest : UAELBRequest

@property (nonatomic, copy) NSString *loadBalancerName;
@property (nonatomic, strong) NSMutableArray *subnets;
// @property (nonatomic, copy) UAELBAttachLoadBalancerToSubnetsRequestCompletionBlock UA_RequestCompletionBlock;
