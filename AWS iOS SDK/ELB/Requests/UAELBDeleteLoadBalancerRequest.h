//
//  UAELBDeleteLoadBalancerRequest.h
//  AWS iOS SDK
//
...
@class UAELBDeleteLoadBalancerResponse;

typedef void(^UAELBDeleteLoadBalancerRequestCompletionBlock)(UAELBDeleteLoadBalancerResponse *response, NSError *error);
typedef BOOL(^UAELBDeleteLoadBalancerRequestShouldContinueWaitingBlock)(UAELBDeleteLoadBalancerResponse *response, NSError *error);

@interface UAELBDeleteLoadBalancerRequest : UAELBRequest

@property (nonatomic, copy) NSString *loadBalancerName;
// @property (nonatomic, copy) UAELBDeleteLoadBalancerRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAELBDeleteLoadBalancerRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
