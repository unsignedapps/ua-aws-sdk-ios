//
//  UAELBConfigureHealthCheckRequest.h
//  AWS iOS SDK
//
...
@class UAELBHealthCheck, UAELBConfigureHealthCheckResponse;

typedef void(^UAELBConfigureHealthCheckRequestCompletionBlock)(UAELBConfigureHealthCheckResponse *response, NSError *error);
typedef BOOL(^UAELBConfigureHealthCheckRequestShouldContinueWaitingBlock)(UAELBConfigureHealthCheckResponse *response, NSError *error);

@interface UAELBConfigureHealthCheckRequest : UAELBRequest

@property (nonatomic, copy) NSString *loadBalancerName;
@property (nonatomic, copy) UAELBHealthCheck *healthCheck;
// @property (nonatomic, copy) UAELBConfigureHealthCheckRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAELBConfigureHealthCheckRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
