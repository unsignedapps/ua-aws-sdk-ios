//
//  UAELBCreateLBCookieStickinessPolicyRequest.h
//  AWS iOS SDK
//
...
@class UAELBCreateLBCookieStickinessPolicyResponse;

typedef void(^UAELBCreateLBCookieStickinessPolicyRequestCompletionBlock)(UAELBCreateLBCookieStickinessPolicyResponse *response, NSError *error);
typedef BOOL(^UAELBCreateLBCookieStickinessPolicyRequestShouldContinueWaitingBlock)(UAELBCreateLBCookieStickinessPolicyResponse *response, NSError *error);

@interface UAELBCreateLBCookieStickinessPolicyRequest : UAELBRequest
...
// @property (nonatomic, copy) UAELBCreateLBCookieStickinessPolicyRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAELBCreateLBCookieStickinessPolicyRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
