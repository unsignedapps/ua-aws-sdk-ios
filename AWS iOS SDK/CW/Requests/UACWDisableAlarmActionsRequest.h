//
//  UACWDisableAlarmActionsRequest.h
//  AWS iOS SDK
//
...
@class UACWDisableAlarmActionsResponse;

typedef void(^UACWDisableAlarmActionsRequestCompletionBlock)(UACWDisableAlarmActionsResponse *response, NSError *error);
typedef BOOL(^UACWDisableAlarmActionsRequestShouldContinueWaitingBlock)(UACWDisableAlarmActionsResponse *response, NSError *error);

@interface UACWDisableAlarmActionsRequest : UACWRequest

@property (nonatomic, strong) NSMutableArray *alarmNames;
// @property (nonatomic, copy) UACWDisableAlarmActionsRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UACWDisableAlarmActionsRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
