...
@class UACWDeleteAlarmsResponse;

typedef void(^UACWDeleteAlarmsRequestCompletionBlock)(UACWDeleteAlarmsResponse *response, NSError *error);
typedef BOOL(^UACWDeleteAlarmsRequestShouldContinueWaitingBlock)(UACWDeleteAlarmsResponse *response, NSError *error);

@interface UACWDeleteAlarmsRequest : UACWRequest

@property (nonatomic, strong) NSMutableArray *alarmNames;
// @property (nonatomic, copy) UACWDeleteAlarmsRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UACWDeleteAlarmsRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
