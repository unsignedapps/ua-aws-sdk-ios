//
//  UACWDescribeAlarmHistoryRequest.h
//  AWS iOS SDK
//
...
@class UACWDescribeAlarmHistoryResponse;

typedef void(^UACWDescribeAlarmHistoryRequestCompletionBlock)(UACWDescribeAlarmHistoryResponse *response, NSError *error);
typedef BOOL(^UACWDescribeAlarmHistoryRequestShouldContinueWaitingBlock)(UACWDescribeAlarmHistoryResponse *response, NSError *error);

@interface UACWDescribeAlarmHistoryRequest : UACWRequest
...
// @property (nonatomic, copy) UACWDescribeAlarmHistoryRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UACWDescribeAlarmHistoryRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
