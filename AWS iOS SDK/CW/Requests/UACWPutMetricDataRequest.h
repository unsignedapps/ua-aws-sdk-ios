...
@class UACWMetricDatum, UACWPutMetricDataResponse;

typedef void(^UACWPutMetricDataRequestCompletionBlock)(UACWPutMetricDataResponse *response, NSError *error);
typedef BOOL(^UACWPutMetricDataRequestShouldContinueWaitingBlock)(UACWPutMetricDataResponse *response, NSError *error);

@interface UACWPutMetricDataRequest : UACWRequest

@property (nonatomic, copy) NSString *namespace;
@property (nonatomic, strong) NSMutableArray *metricData;
// @property (nonatomic, copy) UACWPutMetricDataRequestCompletionBlock UA_RequestCompletionBlock;
