...
@class UASQSDeleteQueueResponse;

typedef void(^UASQSDeleteQueueRequestCompletionBlock)(UASQSDeleteQueueResponse *response, NSError *error);
typedef BOOL(^UASQSDeleteQueueRequestShouldContinueWaitingBlock)(UASQSDeleteQueueResponse *response, NSError *error);
