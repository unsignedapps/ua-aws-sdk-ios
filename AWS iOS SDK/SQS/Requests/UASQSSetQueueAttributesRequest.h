...
@class UASQSSetQueueAttributesResponse;

typedef void(^UASQSSetQueueAttributesRequestCompletionBlock)(UASQSSetQueueAttributesResponse *response, NSError *error);
typedef BOOL(^UASQSSetQueueAttributesRequestShouldContinueWaitingBlock)(UASQSSetQueueAttributesResponse *response, NSError *error);

@interface UASQSSetQueueAttributesRequest : UASQSRequest
