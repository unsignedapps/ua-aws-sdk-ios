...
@class UASQSDeleteMessageResponse;

typedef void(^UASQSDeleteMessageRequestCompletionBlock)(UASQSDeleteMessageResponse *response, NSError *error);
typedef BOOL(^UASQSDeleteMessageRequestShouldContinueWaitingBlock)(UASQSDeleteMessageResponse *response, NSError *error);
