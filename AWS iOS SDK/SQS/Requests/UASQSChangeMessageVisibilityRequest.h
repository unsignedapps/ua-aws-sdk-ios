//
//  UASQSChangeMessageVisibilityRequest.h
//  AWS iOS SDK
//
...
@class UASQSChangeMessageVisibilityResponse;

typedef void(^UASQSChangeMessageVisibilityRequestCompletionBlock)(UASQSChangeMessageVisibilityResponse *response, NSError *error);
typedef BOOL(^UASQSChangeMessageVisibilityRequestShouldContinueWaitingBlock)(UASQSChangeMessageVisibilityResponse *response, NSError *error);
...
// @property (nonatomic, copy) UASQSChangeMessageVisibilityRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
