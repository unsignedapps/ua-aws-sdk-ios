//
//  UASQSSendMessageBatchRequest.h
//  AWS iOS SDK
//
...
@class UASQSSendMessageBatchRequestEntry, UASQSSendMessageBatchResponse;

typedef void(^UASQSSendMessageBatchRequestCompletionBlock)(UASQSSendMessageBatchResponse *response, NSError *error);
typedef BOOL(^UASQSSendMessageBatchRequestShouldContinueWaitingBlock)(UASQSSendMessageBatchResponse *response, NSError *error);

@interface UASQSSendMessageBatchRequest : UASQSRequest

@property (nonatomic, copy) NSString *queueUrl;
@property (nonatomic, strong) NSMutableArray *entries;
// @property (nonatomic, copy) UASQSSendMessageBatchRequestCompletionBlock UA_RequestCompletionBlock;
