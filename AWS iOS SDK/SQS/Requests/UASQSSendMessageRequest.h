...
@class UASQSSendMessageResponse;

typedef void(^UASQSSendMessageRequestCompletionBlock)(UASQSSendMessageResponse *response, NSError *error);
typedef BOOL(^UASQSSendMessageRequestShouldContinueWaitingBlock)(UASQSSendMessageResponse *response, NSError *error);

@interface UASQSSendMessageRequest : UASQSRequest

@property (nonatomic, copy) NSString *queueUrl;
@property (nonatomic, copy) NSString *messageBody;
@property (nonatomic, strong) NSNumber *delaySeconds;
// @property (nonatomic, copy) UASQSSendMessageRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UASQSSendMessageRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
