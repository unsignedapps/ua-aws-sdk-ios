...
@class UASQSCreateQueueResponse;

typedef void(^UASQSCreateQueueRequestCompletionBlock)(UASQSCreateQueueResponse *response, NSError *error);
typedef BOOL(^UASQSCreateQueueRequestShouldContinueWaitingBlock)(UASQSCreateQueueResponse *response, NSError *error);

@interface UASQSCreateQueueRequest : UASQSRequest

@property (nonatomic, copy) NSString *queueName;
@property (nonatomic, strong) NSMutableDictionary *attributes;
// @property (nonatomic, copy) UASQSCreateQueueRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UASQSCreateQueueRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
