//
//  UASQSDeleteMessageBatchRequest.h
//  AWS iOS SDK
//
...
@class UASQSDeleteMessageBatchRequestEntry, UASQSDeleteMessageBatchResponse;

typedef void(^UASQSDeleteMessageBatchRequestCompletionBlock)(UASQSDeleteMessageBatchResponse *response, NSError *error);
typedef BOOL(^UASQSDeleteMessageBatchRequestShouldContinueWaitingBlock)(UASQSDeleteMessageBatchResponse *response, NSError *error);

@interface UASQSDeleteMessageBatchRequest : UASQSRequest

@property (nonatomic, copy) NSString *queueURL;
@property (nonatomic, strong) NSMutableArray *entries;
// @property (nonatomic, copy) UASQSDeleteMessageBatchRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UASQSDeleteMessageBatchRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;

/**
 * Retrieves the UASQSDeleteMessageBatchRequestEntry at the specified index.
**/
