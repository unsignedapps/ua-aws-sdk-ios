//
//  UASQSRemovePermissionRequest.h
//  AWS iOS SDK
//
...
@class UASQSRemovePermissionResponse;

typedef void(^UASQSRemovePermissionRequestCompletionBlock)(UASQSRemovePermissionResponse *response, NSError *error);
typedef BOOL(^UASQSRemovePermissionRequestShouldContinueWaitingBlock)(UASQSRemovePermissionResponse *response, NSError *error);
