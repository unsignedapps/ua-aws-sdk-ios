//
//  UAEC2ModifyVPCAttributeRequest.h
//  AWS iOS SDK
//
...
@class UAEC2EnableDNSSupport, UAEC2EnableDNSHostnames, UAEC2ModifyVPCAttributeResponse;

typedef void(^UAEC2ModifyVPCAttributeRequestCompletionBlock)(UAEC2ModifyVPCAttributeResponse *response, NSError *error);
typedef BOOL(^UAEC2ModifyVPCAttributeRequestShouldContinueWaitingBlock)(UAEC2ModifyVPCAttributeResponse *response, NSError *error);

@interface UAEC2ModifyVPCAttributeRequest : UAEC2Request
...
// @property (nonatomic, copy) UAEC2ModifyVPCAttributeRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2ModifyVPCAttributeRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
