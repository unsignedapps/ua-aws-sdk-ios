...
@class UAEC2AllocateAddressResponse;

typedef void(^UAEC2AllocateAddressRequestCompletionBlock)(UAEC2AllocateAddressResponse *response, NSError *error);
typedef BOOL(^UAEC2AllocateAddressRequestShouldContinueWaitingBlock)(UAEC2AllocateAddressResponse *response, NSError *error);

@interface UAEC2AllocateAddressRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic) UAEC2Domain domain;
// @property (nonatomic, copy) UAEC2AllocateAddressRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2AllocateAddressRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
