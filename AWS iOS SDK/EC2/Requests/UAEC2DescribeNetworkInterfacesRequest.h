//
//  UAEC2DescribeNetworkInterfacesRequest.h
//  AWS iOS SDK
//
...
@class UAEC2Filter, UAEC2DescribeNetworkInterfacesResponse;

typedef void(^UAEC2DescribeNetworkInterfacesRequestCompletionBlock)(UAEC2DescribeNetworkInterfacesResponse *response, NSError *error);
typedef BOOL(^UAEC2DescribeNetworkInterfacesRequestShouldContinueWaitingBlock)(UAEC2DescribeNetworkInterfacesResponse *response, NSError *error);

@interface UAEC2DescribeNetworkInterfacesRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic, strong) NSMutableArray *networkInterfaceIDs;
@property (nonatomic, strong) NSMutableArray *filters;
// @property (nonatomic, copy) UAEC2DescribeNetworkInterfacesRequestCompletionBlock UA_RequestCompletionBlock;
