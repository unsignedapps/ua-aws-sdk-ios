//
//  UAEC2DescribeReservedInstancesListingsRequest.h
//  AWS iOS SDK
//
...
@class UAEC2Filter, UAEC2DescribeReservedInstancesListingsResponse;

typedef void(^UAEC2DescribeReservedInstancesListingsRequestCompletionBlock)(UAEC2DescribeReservedInstancesListingsResponse *response, NSError *error);
typedef BOOL(^UAEC2DescribeReservedInstancesListingsRequestShouldContinueWaitingBlock)(UAEC2DescribeReservedInstancesListingsResponse *response, NSError *error);

@interface UAEC2DescribeReservedInstancesListingsRequest : UAEC2Request

@property (nonatomic, copy) NSString *reservedInstancesID;
@property (nonatomic, copy) NSString *reservedInstancesListingID;
@property (nonatomic, strong) NSMutableArray *filters;
// @property (nonatomic, copy) UAEC2DescribeReservedInstancesListingsRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2DescribeReservedInstancesListingsRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
