...
@class UAEC2Filter, UAEC2DescribeVolumesResponse;

typedef void(^UAEC2DescribeVolumesRequestCompletionBlock)(UAEC2DescribeVolumesResponse *response, NSError *error);
typedef BOOL(^UAEC2DescribeVolumesRequestShouldContinueWaitingBlock)(UAEC2DescribeVolumesResponse *response, NSError *error);

@interface UAEC2DescribeVolumesRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic, strong) NSMutableArray *volumeIDs;
@property (nonatomic, strong) NSMutableArray *filters;
// @property (nonatomic, copy) UAEC2DescribeVolumesRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2DescribeVolumesRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
