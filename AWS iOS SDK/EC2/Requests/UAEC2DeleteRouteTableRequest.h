//
//  UAEC2DeleteRouteTableRequest.h
//  AWS iOS SDK
//
...
@class UAEC2DeleteRouteTableResponse;

typedef void(^UAEC2DeleteRouteTableRequestCompletionBlock)(UAEC2DeleteRouteTableResponse *response, NSError *error);
typedef BOOL(^UAEC2DeleteRouteTableRequestShouldContinueWaitingBlock)(UAEC2DeleteRouteTableResponse *response, NSError *error);

@interface UAEC2DeleteRouteTableRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic, copy) NSString *routeTableID;
// @property (nonatomic, copy) UAEC2DeleteRouteTableRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2DeleteRouteTableRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
