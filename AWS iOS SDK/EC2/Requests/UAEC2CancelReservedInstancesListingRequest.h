//
//  UAEC2CancelReservedInstancesListingRequest.h
//  AWS iOS SDK
//
...
@class UAEC2CancelReservedInstancesListingResponse;

typedef void(^UAEC2CancelReservedInstancesListingRequestCompletionBlock)(UAEC2CancelReservedInstancesListingResponse *response, NSError *error);
typedef BOOL(^UAEC2CancelReservedInstancesListingRequestShouldContinueWaitingBlock)(UAEC2CancelReservedInstancesListingResponse *response, NSError *error);

@interface UAEC2CancelReservedInstancesListingRequest : UAEC2Request

@property (nonatomic, copy) NSString *reservedInstancesListingID;
// @property (nonatomic, copy) UAEC2CancelReservedInstancesListingRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2CancelReservedInstancesListingRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
