...
@class UAEC2DeleteSnapshotResponse;

typedef void(^UAEC2DeleteSnapshotRequestCompletionBlock)(UAEC2DeleteSnapshotResponse *response, NSError *error);
typedef BOOL(^UAEC2DeleteSnapshotRequestShouldContinueWaitingBlock)(UAEC2DeleteSnapshotResponse *response, NSError *error);

@interface UAEC2DeleteSnapshotRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic, copy) NSString *snapshotID;
// @property (nonatomic, copy) UAEC2DeleteSnapshotRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2DeleteSnapshotRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
