...
@class UAEC2CopySnapshotResponse;

typedef void(^UAEC2CopySnapshotRequestCompletionBlock)(UAEC2CopySnapshotResponse *response, NSError *error);
typedef BOOL(^UAEC2CopySnapshotRequestShouldContinueWaitingBlock)(UAEC2CopySnapshotResponse *response, NSError *error);

@interface UAEC2CopySnapshotRequest : UAEC2Request
