//
//  UAEC2DescribeConversionTasksRequest.h
//  AWS iOS SDK
//
...
@class UAEC2Filter, UAEC2DescribeConversionTasksResponse;

typedef void(^UAEC2DescribeConversionTasksRequestCompletionBlock)(UAEC2DescribeConversionTasksResponse *response, NSError *error);
typedef BOOL(^UAEC2DescribeConversionTasksRequestShouldContinueWaitingBlock)(UAEC2DescribeConversionTasksResponse *response, NSError *error);

@interface UAEC2DescribeConversionTasksRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic, strong) NSMutableArray *filters;
@property (nonatomic, strong) NSMutableArray *conversionTaskIDs;
// @property (nonatomic, copy) UAEC2DescribeConversionTasksRequestCompletionBlock UA_RequestCompletionBlock;
...
/**
 * Adds a ConversionTaskID to the conversionTaskIDs property.
 *
 * This will initialise conversionTaskIDs with an empty mutable array if necessary.
**/
