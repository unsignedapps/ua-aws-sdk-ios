...
@class UAEC2CreateSubnetResponse;

typedef void(^UAEC2CreateSubnetRequestCompletionBlock)(UAEC2CreateSubnetResponse *response, NSError *error);
typedef BOOL(^UAEC2CreateSubnetRequestShouldContinueWaitingBlock)(UAEC2CreateSubnetResponse *response, NSError *error);

@interface UAEC2CreateSubnetRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic, copy) NSString *vpcID;
@property (nonatomic, copy) NSString *cidrBlock;
@property (nonatomic, copy) NSString *availabilityZone;
// @property (nonatomic, copy) UAEC2CreateSubnetRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2CreateSubnetRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
