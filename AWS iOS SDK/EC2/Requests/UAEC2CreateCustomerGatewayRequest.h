//
//  UAEC2CreateCustomerGatewayRequest.h
//  AWS iOS SDK
//
...
@class UAEC2CreateCustomerGatewayResponse;

typedef void(^UAEC2CreateCustomerGatewayRequestCompletionBlock)(UAEC2CreateCustomerGatewayResponse *response, NSError *error);
typedef BOOL(^UAEC2CreateCustomerGatewayRequestShouldContinueWaitingBlock)(UAEC2CreateCustomerGatewayResponse *response, NSError *error);

@interface UAEC2CreateCustomerGatewayRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic, copy) NSString *type;
@property (nonatomic, copy) NSString *publicIP;
@property (nonatomic, strong) NSNumber *bgpASN;
// @property (nonatomic, copy) UAEC2CreateCustomerGatewayRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2CreateCustomerGatewayRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
