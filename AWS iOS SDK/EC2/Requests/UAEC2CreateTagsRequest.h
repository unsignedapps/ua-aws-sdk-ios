...
@class UAEC2Tag, UAEC2CreateTagsResponse;

typedef void(^UAEC2CreateTagsRequestCompletionBlock)(UAEC2CreateTagsResponse *response, NSError *error);
typedef BOOL(^UAEC2CreateTagsRequestShouldContinueWaitingBlock)(UAEC2CreateTagsResponse *response, NSError *error);

@interface UAEC2CreateTagsRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic, strong) NSMutableArray *resources;
@property (nonatomic, strong) NSMutableArray *tags;
// @property (nonatomic, copy) UAEC2CreateTagsRequestCompletionBlock UA_RequestCompletionBlock;
