//
//  UAEC2DescribeSecurityGroupsRequest.h
//  AWS iOS SDK
//
...
@class UAEC2Filter, UAEC2DescribeSecurityGroupsResponse;

typedef void(^UAEC2DescribeSecurityGroupsRequestCompletionBlock)(UAEC2DescribeSecurityGroupsResponse *response, NSError *error);
typedef BOOL(^UAEC2DescribeSecurityGroupsRequestShouldContinueWaitingBlock)(UAEC2DescribeSecurityGroupsResponse *response, NSError *error);

@interface UAEC2DescribeSecurityGroupsRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic, strong) NSMutableArray *groupNames;
@property (nonatomic, strong) NSMutableArray *groupIDs;
@property (nonatomic, strong) NSMutableArray *filters;
// @property (nonatomic, copy) UAEC2DescribeSecurityGroupsRequestCompletionBlock UA_RequestCompletionBlock;
...
/**
 * Adds a GroupID to the groupIDs property.
 *
 * This will initialise groupIDs with an empty mutable array if necessary.
**/
