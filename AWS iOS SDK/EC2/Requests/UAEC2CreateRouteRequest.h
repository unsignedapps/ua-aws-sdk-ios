...
@class UAEC2CreateRouteResponse;

typedef void(^UAEC2CreateRouteRequestCompletionBlock)(UAEC2CreateRouteResponse *response, NSError *error);
typedef BOOL(^UAEC2CreateRouteRequestShouldContinueWaitingBlock)(UAEC2CreateRouteResponse *response, NSError *error);

@interface UAEC2CreateRouteRequest : UAEC2Request
