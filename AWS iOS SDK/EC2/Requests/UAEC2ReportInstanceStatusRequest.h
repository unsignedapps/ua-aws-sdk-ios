//
//  UAEC2ReportInstanceStatusRequest.h
//  AWS iOS SDK
//
...
@class UAEC2ReportInstanceStatusResponse;

typedef void(^UAEC2ReportInstanceStatusRequestCompletionBlock)(UAEC2ReportInstanceStatusResponse *response, NSError *error);
typedef BOOL(^UAEC2ReportInstanceStatusRequestShouldContinueWaitingBlock)(UAEC2ReportInstanceStatusResponse *response, NSError *error);

@interface UAEC2ReportInstanceStatusRequest : UAEC2Request
...
// @property (nonatomic, copy) UAEC2ReportInstanceStatusRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2ReportInstanceStatusRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
...
/**
 * Adds a ReasonCode to the reasonCodes property.
 *
 * This will initialise reasonCodes with an empty mutable array if necessary.
**/
