...
@class UAEC2BlockDeviceMapping, UAEC2CreateImageResponse;

typedef void(^UAEC2CreateImageRequestCompletionBlock)(UAEC2CreateImageResponse *response, NSError *error);
typedef BOOL(^UAEC2CreateImageRequestShouldContinueWaitingBlock)(UAEC2CreateImageResponse *response, NSError *error);

@interface UAEC2CreateImageRequest : UAEC2Request
...
// @property (nonatomic, copy) UAEC2CreateImageRequestCompletionBlock UA_RequestCompletionBlock;
