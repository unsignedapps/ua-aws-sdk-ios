//
//  UAEC2DescribeNetworkInterfaceAttributeRequest.h
//  AWS iOS SDK
//
...
@class UAEC2DescribeNetworkInterfaceAttributeResponse;

typedef void(^UAEC2DescribeNetworkInterfaceAttributeRequestCompletionBlock)(UAEC2DescribeNetworkInterfaceAttributeResponse *response, NSError *error);
typedef BOOL(^UAEC2DescribeNetworkInterfaceAttributeRequestShouldContinueWaitingBlock)(UAEC2DescribeNetworkInterfaceAttributeResponse *response, NSError *error);

@interface UAEC2DescribeNetworkInterfaceAttributeRequest : UAEC2Request
