//
//  UAEC2DeleteDHCPOptionsRequest.h
//  AWS iOS SDK
//
...
@class UAEC2DeleteDHCPOptionsResponse;

typedef void(^UAEC2DeleteDHCPOptionsRequestCompletionBlock)(UAEC2DeleteDHCPOptionsResponse *response, NSError *error);
typedef BOOL(^UAEC2DeleteDHCPOptionsRequestShouldContinueWaitingBlock)(UAEC2DeleteDHCPOptionsResponse *response, NSError *error);

@interface UAEC2DeleteDHCPOptionsRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic, copy) NSString *dhcpOptionsID;
// @property (nonatomic, copy) UAEC2DeleteDHCPOptionsRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2DeleteDHCPOptionsRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
