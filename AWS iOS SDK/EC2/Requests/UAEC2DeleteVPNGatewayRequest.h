//
//  UAEC2DeleteVPNGatewayRequest.h
//  AWS iOS SDK
//
...
@class UAEC2DeleteVPNGatewayResponse;

typedef void(^UAEC2DeleteVPNGatewayRequestCompletionBlock)(UAEC2DeleteVPNGatewayResponse *response, NSError *error);
typedef BOOL(^UAEC2DeleteVPNGatewayRequestShouldContinueWaitingBlock)(UAEC2DeleteVPNGatewayResponse *response, NSError *error);

@interface UAEC2DeleteVPNGatewayRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic, copy) NSString *vpnGatewayID;
// @property (nonatomic, copy) UAEC2DeleteVPNGatewayRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2DeleteVPNGatewayRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
