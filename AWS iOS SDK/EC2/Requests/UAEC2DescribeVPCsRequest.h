...
@class UAEC2Filter, UAEC2DescribeVPCsResponse;

typedef void(^UAEC2DescribeVPCsRequestCompletionBlock)(UAEC2DescribeVPCsResponse *response, NSError *error);
typedef BOOL(^UAEC2DescribeVPCsRequestShouldContinueWaitingBlock)(UAEC2DescribeVPCsResponse *response, NSError *error);

@interface UAEC2DescribeVPCsRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic, strong) NSMutableArray *vpcIDs;
@property (nonatomic, strong) NSMutableArray *filters;
// @property (nonatomic, copy) UAEC2DescribeVPCsRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2DescribeVPCsRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
