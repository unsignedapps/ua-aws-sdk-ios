//
//  UAEC2DescribeKeyPairsRequest.h
//  AWS iOS SDK
//
...
@class UAEC2Filter, UAEC2DescribeKeyPairsResponse;

typedef void(^UAEC2DescribeKeyPairsRequestCompletionBlock)(UAEC2DescribeKeyPairsResponse *response, NSError *error);
typedef BOOL(^UAEC2DescribeKeyPairsRequestShouldContinueWaitingBlock)(UAEC2DescribeKeyPairsResponse *response, NSError *error);

@interface UAEC2DescribeKeyPairsRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic, strong) NSMutableArray *keyNames;
@property (nonatomic, strong) NSMutableArray *filters;
// @property (nonatomic, copy) UAEC2DescribeKeyPairsRequestCompletionBlock UA_RequestCompletionBlock;
