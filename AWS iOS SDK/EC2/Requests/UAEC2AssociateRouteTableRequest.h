//
//  UAEC2AssociateRouteTableRequest.h
//  AWS iOS SDK
//
...
@class UAEC2AssociateRouteTableResponse;

typedef void(^UAEC2AssociateRouteTableRequestCompletionBlock)(UAEC2AssociateRouteTableResponse *response, NSError *error);
typedef BOOL(^UAEC2AssociateRouteTableRequestShouldContinueWaitingBlock)(UAEC2AssociateRouteTableResponse *response, NSError *error);

@interface UAEC2AssociateRouteTableRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic, copy) NSString *subnetID;
@property (nonatomic, copy) NSString *routeTableID;
// @property (nonatomic, copy) UAEC2AssociateRouteTableRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2AssociateRouteTableRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
