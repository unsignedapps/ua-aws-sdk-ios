//
//  UAEC2TerminateInstancesRequest.h
//  AWS iOS SDK
//
...
@class UAEC2TerminateInstancesResponse;

typedef void(^UAEC2TerminateInstancesRequestCompletionBlock)(UAEC2TerminateInstancesResponse *response, NSError *error);
typedef BOOL(^UAEC2TerminateInstancesRequestShouldContinueWaitingBlock)(UAEC2TerminateInstancesResponse *response, NSError *error);

@interface UAEC2TerminateInstancesRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic, strong) NSMutableArray *instanceIDs;
// @property (nonatomic, copy) UAEC2TerminateInstancesRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2TerminateInstancesRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
