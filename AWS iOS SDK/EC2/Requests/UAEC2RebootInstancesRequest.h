...
@class UAEC2RebootInstancesResponse;

typedef void(^UAEC2RebootInstancesRequestCompletionBlock)(UAEC2RebootInstancesResponse *response, NSError *error);
typedef BOOL(^UAEC2RebootInstancesRequestShouldContinueWaitingBlock)(UAEC2RebootInstancesResponse *response, NSError *error);

@interface UAEC2RebootInstancesRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic, strong) NSMutableArray *instanceIDs;
// @property (nonatomic, copy) UAEC2RebootInstancesRequestCompletionBlock UA_RequestCompletionBlock;
