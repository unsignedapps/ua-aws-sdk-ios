//
//  UAEC2CreateVPNConnectionRequest.h
//  AWS iOS SDK
//
...
@class UAEC2Options, UAEC2CreateVPNConnectionResponse;

typedef void(^UAEC2CreateVPNConnectionRequestCompletionBlock)(UAEC2CreateVPNConnectionResponse *response, NSError *error);
typedef BOOL(^UAEC2CreateVPNConnectionRequestShouldContinueWaitingBlock)(UAEC2CreateVPNConnectionResponse *response, NSError *error);

@interface UAEC2CreateVPNConnectionRequest : UAEC2Request
...
// @property (nonatomic, copy) UAEC2CreateVPNConnectionRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2CreateVPNConnectionRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
