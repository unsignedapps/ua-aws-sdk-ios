...
@class UAEC2Filter, UAEC2DescribeRegionsResponse;

typedef void(^UAEC2DescribeRegionsRequestCompletionBlock)(UAEC2DescribeRegionsResponse *response, NSError *error);
typedef BOOL(^UAEC2DescribeRegionsRequestShouldContinueWaitingBlock)(UAEC2DescribeRegionsResponse *response, NSError *error);

@interface UAEC2DescribeRegionsRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic, strong) NSMutableArray *regionNames;
@property (nonatomic, strong) NSMutableArray *filters;
// @property (nonatomic, copy) UAEC2DescribeRegionsRequestCompletionBlock UA_RequestCompletionBlock;
