//
//  UAEC2DescribeRouteTablesRequest.h
//  AWS iOS SDK
//
...
@class UAEC2Filter, UAEC2DescribeRouteTablesResponse;

typedef void(^UAEC2DescribeRouteTablesRequestCompletionBlock)(UAEC2DescribeRouteTablesResponse *response, NSError *error);
typedef BOOL(^UAEC2DescribeRouteTablesRequestShouldContinueWaitingBlock)(UAEC2DescribeRouteTablesResponse *response, NSError *error);

@interface UAEC2DescribeRouteTablesRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic, strong) NSMutableArray *routeTableIDs;
@property (nonatomic, strong) NSMutableArray *filters;
// @property (nonatomic, copy) UAEC2DescribeRouteTablesRequestCompletionBlock UA_RequestCompletionBlock;
