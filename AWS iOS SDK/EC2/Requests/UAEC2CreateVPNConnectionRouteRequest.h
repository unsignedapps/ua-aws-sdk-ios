//
//  UAEC2CreateVPNConnectionRouteRequest.h
//  AWS iOS SDK
//
...
@class UAEC2CreateVPNConnectionRouteResponse;

typedef void(^UAEC2CreateVPNConnectionRouteRequestCompletionBlock)(UAEC2CreateVPNConnectionRouteResponse *response, NSError *error);
typedef BOOL(^UAEC2CreateVPNConnectionRouteRequestShouldContinueWaitingBlock)(UAEC2CreateVPNConnectionRouteResponse *response, NSError *error);

@interface UAEC2CreateVPNConnectionRouteRequest : UAEC2Request

@property (nonatomic, copy) NSString *vpnConnectionID;
@property (nonatomic, copy) NSString *destinationCidrBlock;
// @property (nonatomic, copy) UAEC2CreateVPNConnectionRouteRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2CreateVPNConnectionRouteRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
