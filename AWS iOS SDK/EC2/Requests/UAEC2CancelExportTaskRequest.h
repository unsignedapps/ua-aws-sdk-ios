//
//  UAEC2CancelExportTaskRequest.h
//  AWS iOS SDK
//
...
@class UAEC2CancelExportTaskResponse;

typedef void(^UAEC2CancelExportTaskRequestCompletionBlock)(UAEC2CancelExportTaskResponse *response, NSError *error);
typedef BOOL(^UAEC2CancelExportTaskRequestShouldContinueWaitingBlock)(UAEC2CancelExportTaskResponse *response, NSError *error);

@interface UAEC2CancelExportTaskRequest : UAEC2Request

@property (nonatomic, copy) NSString *exportTaskID;
// @property (nonatomic, copy) UAEC2CancelExportTaskRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2CancelExportTaskRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
