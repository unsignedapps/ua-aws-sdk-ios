//
//  UAEC2DescribeLicensesRequest.h
//  AWS iOS SDK
//
...
@class UAEC2Filter, UAEC2DescribeLicensesResponse;

typedef void(^UAEC2DescribeLicensesRequestCompletionBlock)(UAEC2DescribeLicensesResponse *response, NSError *error);
typedef BOOL(^UAEC2DescribeLicensesRequestShouldContinueWaitingBlock)(UAEC2DescribeLicensesResponse *response, NSError *error);

@interface UAEC2DescribeLicensesRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic, strong) NSMutableArray *licenseIDs;
@property (nonatomic, strong) NSMutableArray *filters;
// @property (nonatomic, copy) UAEC2DescribeLicensesRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2DescribeLicensesRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;

/**
 * Adds a LicenseID to the licenseIDs property.
 *
 * This will initialise licenseIDs with an empty mutable array if necessary.
**/
