...
- (id)init
{
	if (self = [super init])
	{
		...
		[self UA_addAtIndexAdditionalAccessorForSelector:@selector(vpcPeeringConnectionIDAtIndex:) propertyName:@"vpcPeeringConnectionIDs"];
		[self UA_addAtIndexAdditionalAccessorForSelector:@selector(filterAtIndex:) propertyName:@"filters"];
		[self UA_addAddObjectAdditionalAccessorForSelector:@selector(addVPCPeeringConnectionID:) propertyName:@"vpcPeeringConnectionIDs"];
