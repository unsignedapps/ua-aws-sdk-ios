//
//  UAEC2DetachVPNGatewayRequest.h
//  AWS iOS SDK
//
...
@class UAEC2DetachVPNGatewayResponse;

typedef void(^UAEC2DetachVPNGatewayRequestCompletionBlock)(UAEC2DetachVPNGatewayResponse *response, NSError *error);
typedef BOOL(^UAEC2DetachVPNGatewayRequestShouldContinueWaitingBlock)(UAEC2DetachVPNGatewayResponse *response, NSError *error);

@interface UAEC2DetachVPNGatewayRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic, copy) NSString *vpnGatewayID;
@property (nonatomic, copy) NSString *vpcID;
// @property (nonatomic, copy) UAEC2DetachVPNGatewayRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2DetachVPNGatewayRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
