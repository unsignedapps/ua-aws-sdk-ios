//
//  UAEC2DescribeSpotInstanceRequestsRequest.h
//  AWS iOS SDK
//
...
@class UAEC2Filter, UAEC2DescribeSpotInstanceRequestsResponse;

typedef void(^UAEC2DescribeSpotInstanceRequestsRequestCompletionBlock)(UAEC2DescribeSpotInstanceRequestsResponse *response, NSError *error);
typedef BOOL(^UAEC2DescribeSpotInstanceRequestsRequestShouldContinueWaitingBlock)(UAEC2DescribeSpotInstanceRequestsResponse *response, NSError *error);

@interface UAEC2DescribeSpotInstanceRequestsRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic, strong) NSMutableArray *spotInstanceRequestIDs;
@property (nonatomic, strong) NSMutableArray *filters;
// @property (nonatomic, copy) UAEC2DescribeSpotInstanceRequestsRequestCompletionBlock UA_RequestCompletionBlock;
