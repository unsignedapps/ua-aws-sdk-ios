//
//  UAEC2RevokeSecurityGroupIngressRequest.h
//  AWS iOS SDK
//
...
@class UAEC2IPPermission, UAEC2RevokeSecurityGroupIngressResponse;

typedef void(^UAEC2RevokeSecurityGroupIngressRequestCompletionBlock)(UAEC2RevokeSecurityGroupIngressResponse *response, NSError *error);
typedef BOOL(^UAEC2RevokeSecurityGroupIngressRequestShouldContinueWaitingBlock)(UAEC2RevokeSecurityGroupIngressResponse *response, NSError *error);

@interface UAEC2RevokeSecurityGroupIngressRequest : UAEC2Request
...
// @property (nonatomic, copy) UAEC2RevokeSecurityGroupIngressRequestCompletionBlock UA_RequestCompletionBlock;
