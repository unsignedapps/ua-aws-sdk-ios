...
- (void)setAutoEnableIO:(BOOL)autoEnableIO
{
	_autoEnableIO = autoEnableIO;
	
	if (![self.UA_dirtyProperties containsObject:@"autoEnableIO"])
		[self.UA_dirtyProperties addObject:@"autoEnableIO"];
}
