...
@class UAEC2ReplaceRouteResponse;

typedef void(^UAEC2ReplaceRouteRequestCompletionBlock)(UAEC2ReplaceRouteResponse *response, NSError *error);
typedef BOOL(^UAEC2ReplaceRouteRequestShouldContinueWaitingBlock)(UAEC2ReplaceRouteResponse *response, NSError *error);

@interface UAEC2ReplaceRouteRequest : UAEC2Request
...
// @property (nonatomic, copy) UAEC2ReplaceRouteRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2ReplaceRouteRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
