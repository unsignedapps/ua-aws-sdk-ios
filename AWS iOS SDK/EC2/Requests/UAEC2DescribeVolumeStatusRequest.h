//
//  UAEC2DescribeVolumeStatusRequest.h
//  AWS iOS SDK
//
...
@class UAEC2Filter, UAEC2DescribeVolumeStatusResponse;

typedef void(^UAEC2DescribeVolumeStatusRequestCompletionBlock)(UAEC2DescribeVolumeStatusResponse *response, NSError *error);
typedef BOOL(^UAEC2DescribeVolumeStatusRequestShouldContinueWaitingBlock)(UAEC2DescribeVolumeStatusResponse *response, NSError *error);

@interface UAEC2DescribeVolumeStatusRequest : UAEC2Request
...
// @property (nonatomic, copy) UAEC2DescribeVolumeStatusRequestCompletionBlock UA_RequestCompletionBlock;
