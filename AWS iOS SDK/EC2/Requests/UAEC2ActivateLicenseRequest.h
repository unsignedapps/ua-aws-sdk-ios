...
@class UAEC2ActivateLicenseResponse;

typedef void(^UAEC2ActivateLicenseRequestCompletionBlock)(UAEC2ActivateLicenseResponse *response, NSError *error);
typedef BOOL(^UAEC2ActivateLicenseRequestShouldContinueWaitingBlock)(UAEC2ActivateLicenseResponse *response, NSError *error);

@interface UAEC2ActivateLicenseRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic, copy) NSString *licenseID;
@property (nonatomic, strong) NSNumber *capacity;
// @property (nonatomic, copy) UAEC2ActivateLicenseRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2ActivateLicenseRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
