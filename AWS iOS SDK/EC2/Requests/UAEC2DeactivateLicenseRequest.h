//
//  UAEC2DeactivateLicenseRequest.h
//  AWS iOS SDK
//
...
@class UAEC2DeactivateLicenseResponse;

typedef void(^UAEC2DeactivateLicenseRequestCompletionBlock)(UAEC2DeactivateLicenseResponse *response, NSError *error);
typedef BOOL(^UAEC2DeactivateLicenseRequestShouldContinueWaitingBlock)(UAEC2DeactivateLicenseResponse *response, NSError *error);

@interface UAEC2DeactivateLicenseRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic, copy) NSString *licenseID;
@property (nonatomic, strong) NSNumber *capacity;
// @property (nonatomic, copy) UAEC2DeactivateLicenseRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2DeactivateLicenseRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
