//
//  UAEC2DeleteVPNConnectionRouteRequest.h
//  AWS iOS SDK
//
...
@class UAEC2DeleteVPNConnectionRouteResponse;

typedef void(^UAEC2DeleteVPNConnectionRouteRequestCompletionBlock)(UAEC2DeleteVPNConnectionRouteResponse *response, NSError *error);
typedef BOOL(^UAEC2DeleteVPNConnectionRouteRequestShouldContinueWaitingBlock)(UAEC2DeleteVPNConnectionRouteResponse *response, NSError *error);

@interface UAEC2DeleteVPNConnectionRouteRequest : UAEC2Request

@property (nonatomic, copy) NSString *vpnConnectionID;
@property (nonatomic, copy) NSString *destinationCidrBlock;
// @property (nonatomic, copy) UAEC2DeleteVPNConnectionRouteRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2DeleteVPNConnectionRouteRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
