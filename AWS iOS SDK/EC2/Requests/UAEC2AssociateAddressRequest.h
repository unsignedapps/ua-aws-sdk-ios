//
//  UAEC2AssociateAddressRequest.h
//  AWS iOS SDK
//
...
@class UAEC2AssociateAddressResponse;

typedef void(^UAEC2AssociateAddressRequestCompletionBlock)(UAEC2AssociateAddressResponse *response, NSError *error);
typedef BOOL(^UAEC2AssociateAddressRequestShouldContinueWaitingBlock)(UAEC2AssociateAddressResponse *response, NSError *error);

@interface UAEC2AssociateAddressRequest : UAEC2Request
...
// @property (nonatomic, copy) UAEC2AssociateAddressRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2AssociateAddressRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
