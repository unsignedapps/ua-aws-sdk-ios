...
- (void)setInternetGatewayIDs:(NSMutableArray *)internetGatewayIDs
{
	_internetGatewayIDs = internetGatewayIDs;
	
	if (![self.UA_dirtyProperties containsObject:@"internetGatewayIDs"])
		[self.UA_dirtyProperties addObject:@"internetGatewayIDs"];
}
