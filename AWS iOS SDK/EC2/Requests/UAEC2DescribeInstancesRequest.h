//
//  UAEC2DescribeInstancesRequest.h
//  AWS iOS SDK
//
...
@class UAEC2Filter, UAEC2DescribeInstancesResponse;

typedef void(^UAEC2DescribeInstancesRequestCompletionBlock)(UAEC2DescribeInstancesResponse *response, NSError *error);
typedef BOOL(^UAEC2DescribeInstancesRequestShouldContinueWaitingBlock)(UAEC2DescribeInstancesResponse *response, NSError *error);

@interface UAEC2DescribeInstancesRequest : UAEC2Request
...
// @property (nonatomic, copy) UAEC2DescribeInstancesRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2DescribeInstancesRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
