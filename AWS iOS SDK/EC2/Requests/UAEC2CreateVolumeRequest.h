...
@class UAEC2CreateVolumeResponse;

typedef void(^UAEC2CreateVolumeRequestCompletionBlock)(UAEC2CreateVolumeResponse *response, NSError *error);
typedef BOOL(^UAEC2CreateVolumeRequestShouldContinueWaitingBlock)(UAEC2CreateVolumeResponse *response, NSError *error);

@interface UAEC2CreateVolumeRequest : UAEC2Request
