//
//  UAEC2AttachVPNGatewayRequest.h
//  AWS iOS SDK
//
...
@class UAEC2AttachVPNGatewayResponse;

typedef void(^UAEC2AttachVPNGatewayRequestCompletionBlock)(UAEC2AttachVPNGatewayResponse *response, NSError *error);
typedef BOOL(^UAEC2AttachVPNGatewayRequestShouldContinueWaitingBlock)(UAEC2AttachVPNGatewayResponse *response, NSError *error);

@interface UAEC2AttachVPNGatewayRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic, copy) NSString *vpnGatewayID;
@property (nonatomic, copy) NSString *vpcID;
// @property (nonatomic, copy) UAEC2AttachVPNGatewayRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2AttachVPNGatewayRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
