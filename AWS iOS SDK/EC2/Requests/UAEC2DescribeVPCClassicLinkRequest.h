//
//  UAEC2DescribeVPCClassicLinkRequest.h
//  AWS iOS SDK
//
...
@class UAEC2Filter, UAEC2DescribeVPCClassicLinkResponse;

typedef void(^UAEC2DescribeVPCClassicLinkRequestCompletionBlock)(UAEC2DescribeVPCClassicLinkResponse *response, NSError *error);
typedef BOOL(^UAEC2DescribeVPCClassicLinkRequestShouldContinueWaitingBlock)(UAEC2DescribeVPCClassicLinkResponse *response, NSError *error);

@interface UAEC2DescribeVPCClassicLinkRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic, strong) NSMutableArray *vpcIDs;
@property (nonatomic, strong) NSMutableArray *filters;
// @property (nonatomic, copy) UAEC2DescribeVPCClassicLinkRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2DescribeVPCClassicLinkRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;

/**
 * Retrieves the NSString at the specified index.
**/
- (NSString *)vpcIDAtIndex:(NSUInteger)index;
...
/**
 * Adds a VPCID to the vpcIDs property.
 *
 * This will initialise vpcIDs with an empty mutable array if necessary.
**/
