...
@class UAEC2Filter, UAEC2DescribeTagsResponse;

typedef void(^UAEC2DescribeTagsRequestCompletionBlock)(UAEC2DescribeTagsResponse *response, NSError *error);
typedef BOOL(^UAEC2DescribeTagsRequestShouldContinueWaitingBlock)(UAEC2DescribeTagsResponse *response, NSError *error);

@interface UAEC2DescribeTagsRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic, strong) NSMutableArray *filters;
@property (nonatomic, strong) NSNumber *maxResults;
@property (nonatomic, copy) NSString *nextToken;
// @property (nonatomic, copy) UAEC2DescribeTagsRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2DescribeTagsRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
