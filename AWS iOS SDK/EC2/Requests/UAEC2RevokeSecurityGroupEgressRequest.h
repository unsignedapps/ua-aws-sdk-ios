//
//  UAEC2RevokeSecurityGroupEgressRequest.h
//  AWS iOS SDK
//
...
@class UAEC2IPPermission, UAEC2RevokeSecurityGroupEgressResponse;

typedef void(^UAEC2RevokeSecurityGroupEgressRequestCompletionBlock)(UAEC2RevokeSecurityGroupEgressResponse *response, NSError *error);
typedef BOOL(^UAEC2RevokeSecurityGroupEgressRequestShouldContinueWaitingBlock)(UAEC2RevokeSecurityGroupEgressResponse *response, NSError *error);

@interface UAEC2RevokeSecurityGroupEgressRequest : UAEC2Request
...
// @property (nonatomic, copy) UAEC2RevokeSecurityGroupEgressRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2RevokeSecurityGroupEgressRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
