//
//  UAEC2DescribePlacementGroupsRequest.h
//  AWS iOS SDK
//
...
@class UAEC2Filter, UAEC2DescribePlacementGroupsResponse;

typedef void(^UAEC2DescribePlacementGroupsRequestCompletionBlock)(UAEC2DescribePlacementGroupsResponse *response, NSError *error);
typedef BOOL(^UAEC2DescribePlacementGroupsRequestShouldContinueWaitingBlock)(UAEC2DescribePlacementGroupsResponse *response, NSError *error);

@interface UAEC2DescribePlacementGroupsRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic, strong) NSMutableArray *groupNames;
@property (nonatomic, strong) NSMutableArray *filters;
// @property (nonatomic, copy) UAEC2DescribePlacementGroupsRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2DescribePlacementGroupsRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
