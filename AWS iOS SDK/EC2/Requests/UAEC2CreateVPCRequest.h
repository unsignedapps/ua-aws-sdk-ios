...
@class UAEC2CreateVPCResponse;

typedef void(^UAEC2CreateVPCRequestCompletionBlock)(UAEC2CreateVPCResponse *response, NSError *error);
typedef BOOL(^UAEC2CreateVPCRequestShouldContinueWaitingBlock)(UAEC2CreateVPCResponse *response, NSError *error);

@interface UAEC2CreateVPCRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic, copy) NSString *cidrBlock;
@property (nonatomic, copy) NSString *instanceTenancy;
// @property (nonatomic, copy) UAEC2CreateVPCRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2CreateVPCRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
