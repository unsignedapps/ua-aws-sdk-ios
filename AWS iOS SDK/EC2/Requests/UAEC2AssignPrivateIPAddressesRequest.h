//
//  UAEC2AssignPrivateIPAddressesRequest.h
//  AWS iOS SDK
//
...
@property (nonatomic) BOOL allowReassignment;
// @property (nonatomic, copy) UAEC2AssignPrivateIPAddressesRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2AssignPrivateIPAddressesRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
