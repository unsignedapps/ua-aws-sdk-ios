...
@class UAEC2DeleteSubnetResponse;

typedef void(^UAEC2DeleteSubnetRequestCompletionBlock)(UAEC2DeleteSubnetResponse *response, NSError *error);
typedef BOOL(^UAEC2DeleteSubnetRequestShouldContinueWaitingBlock)(UAEC2DeleteSubnetResponse *response, NSError *error);

@interface UAEC2DeleteSubnetRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic, copy) NSString *subnetID;
// @property (nonatomic, copy) UAEC2DeleteSubnetRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2DeleteSubnetRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
