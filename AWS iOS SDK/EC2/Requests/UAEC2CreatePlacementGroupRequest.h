//
//  UAEC2CreatePlacementGroupRequest.h
//  AWS iOS SDK
//
...
@class UAEC2CreatePlacementGroupResponse;

typedef void(^UAEC2CreatePlacementGroupRequestCompletionBlock)(UAEC2CreatePlacementGroupResponse *response, NSError *error);
typedef BOOL(^UAEC2CreatePlacementGroupRequestShouldContinueWaitingBlock)(UAEC2CreatePlacementGroupResponse *response, NSError *error);

@interface UAEC2CreatePlacementGroupRequest : UAEC2Request
