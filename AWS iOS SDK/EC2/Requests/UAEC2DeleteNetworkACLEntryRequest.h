//
//  UAEC2DeleteNetworkACLEntryRequest.h
//  AWS iOS SDK
//
...
@class UAEC2DeleteNetworkACLEntryResponse;

typedef void(^UAEC2DeleteNetworkACLEntryRequestCompletionBlock)(UAEC2DeleteNetworkACLEntryResponse *response, NSError *error);
typedef BOOL(^UAEC2DeleteNetworkACLEntryRequestShouldContinueWaitingBlock)(UAEC2DeleteNetworkACLEntryResponse *response, NSError *error);

@interface UAEC2DeleteNetworkACLEntryRequest : UAEC2Request
...
// @property (nonatomic, copy) UAEC2DeleteNetworkACLEntryRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2DeleteNetworkACLEntryRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
