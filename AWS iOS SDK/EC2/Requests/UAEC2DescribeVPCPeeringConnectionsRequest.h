//
//  UAEC2DescribeVPCPeeringConnectionsRequest.h
//  AWS iOS SDK
//
...
@class UAEC2Filter, UAEC2DescribeVPCPeeringConnectionsResponse;

typedef void(^UAEC2DescribeVPCPeeringConnectionsRequestCompletionBlock)(UAEC2DescribeVPCPeeringConnectionsResponse *response, NSError *error);
typedef BOOL(^UAEC2DescribeVPCPeeringConnectionsRequestShouldContinueWaitingBlock)(UAEC2DescribeVPCPeeringConnectionsResponse *response, NSError *error);

@interface UAEC2DescribeVPCPeeringConnectionsRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic, strong) NSMutableArray *vpcPeeringConnectionIDs;
@property (nonatomic, strong) NSMutableArray *filters;
// @property (nonatomic, copy) UAEC2DescribeVPCPeeringConnectionsRequestCompletionBlock UA_RequestCompletionBlock;
