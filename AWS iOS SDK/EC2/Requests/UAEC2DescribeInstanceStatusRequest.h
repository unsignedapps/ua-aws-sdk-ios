//
//  UAEC2DescribeInstanceStatusRequest.h
//  AWS iOS SDK
//
...
@class UAEC2Filter, UAEC2DescribeInstanceStatusResponse;

typedef void(^UAEC2DescribeInstanceStatusRequestCompletionBlock)(UAEC2DescribeInstanceStatusResponse *response, NSError *error);
typedef BOOL(^UAEC2DescribeInstanceStatusRequestShouldContinueWaitingBlock)(UAEC2DescribeInstanceStatusResponse *response, NSError *error);

@interface UAEC2DescribeInstanceStatusRequest : UAEC2Request
...
// @property (nonatomic, copy) UAEC2DescribeInstanceStatusRequestCompletionBlock UA_RequestCompletionBlock;
