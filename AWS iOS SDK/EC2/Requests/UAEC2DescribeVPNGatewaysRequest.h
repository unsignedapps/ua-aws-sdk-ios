//
//  UAEC2DescribeVPNGatewaysRequest.h
//  AWS iOS SDK
//
...
@class UAEC2Filter, UAEC2DescribeVPNGatewaysResponse;

typedef void(^UAEC2DescribeVPNGatewaysRequestCompletionBlock)(UAEC2DescribeVPNGatewaysResponse *response, NSError *error);
typedef BOOL(^UAEC2DescribeVPNGatewaysRequestShouldContinueWaitingBlock)(UAEC2DescribeVPNGatewaysResponse *response, NSError *error);

@interface UAEC2DescribeVPNGatewaysRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic, strong) NSMutableArray *vpnGatewayIDs;
@property (nonatomic, strong) NSMutableArray *filters;
// @property (nonatomic, copy) UAEC2DescribeVPNGatewaysRequestCompletionBlock UA_RequestCompletionBlock;
