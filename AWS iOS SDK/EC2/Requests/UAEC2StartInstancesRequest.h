...
@class UAEC2StartInstancesResponse;

typedef void(^UAEC2StartInstancesRequestCompletionBlock)(UAEC2StartInstancesResponse *response, NSError *error);
typedef BOOL(^UAEC2StartInstancesRequestShouldContinueWaitingBlock)(UAEC2StartInstancesResponse *response, NSError *error);

@interface UAEC2StartInstancesRequest : UAEC2Request

@property (nonatomic, strong) NSMutableArray *instanceIDs;
@property (nonatomic, copy) NSString *additionalInfo;
@property (nonatomic) BOOL dryRun;
// @property (nonatomic, copy) UAEC2StartInstancesRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2StartInstancesRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
