//
//  UAEC2MonitorInstancesRequest.h
//  AWS iOS SDK
//
...
@class UAEC2MonitorInstancesResponse;

typedef void(^UAEC2MonitorInstancesRequestCompletionBlock)(UAEC2MonitorInstancesResponse *response, NSError *error);
typedef BOOL(^UAEC2MonitorInstancesRequestShouldContinueWaitingBlock)(UAEC2MonitorInstancesResponse *response, NSError *error);

@interface UAEC2MonitorInstancesRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic, strong) NSMutableArray *instanceIDs;
// @property (nonatomic, copy) UAEC2MonitorInstancesRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2MonitorInstancesRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
