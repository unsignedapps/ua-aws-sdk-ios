//
//  UAEC2DescribeAccountAttributesRequest.h
//  AWS iOS SDK
//
...
@class UAEC2DescribeAccountAttributesResponse;

typedef void(^UAEC2DescribeAccountAttributesRequestCompletionBlock)(UAEC2DescribeAccountAttributesResponse *response, NSError *error);
typedef BOOL(^UAEC2DescribeAccountAttributesRequestShouldContinueWaitingBlock)(UAEC2DescribeAccountAttributesResponse *response, NSError *error);

@interface UAEC2DescribeAccountAttributesRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic, strong) NSMutableArray *attributeNames;
// @property (nonatomic, copy) UAEC2DescribeAccountAttributesRequestCompletionBlock UA_RequestCompletionBlock;
