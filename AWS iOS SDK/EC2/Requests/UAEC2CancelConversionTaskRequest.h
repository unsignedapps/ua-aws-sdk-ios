//
//  UAEC2CancelConversionTaskRequest.h
//  AWS iOS SDK
//
...
@class UAEC2CancelConversionTaskResponse;

typedef void(^UAEC2CancelConversionTaskRequestCompletionBlock)(UAEC2CancelConversionTaskResponse *response, NSError *error);
typedef BOOL(^UAEC2CancelConversionTaskRequestShouldContinueWaitingBlock)(UAEC2CancelConversionTaskResponse *response, NSError *error);

@interface UAEC2CancelConversionTaskRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic, copy) NSString *conversionTaskID;
@property (nonatomic, copy) NSString *reasonMessage;
// @property (nonatomic, copy) UAEC2CancelConversionTaskRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2CancelConversionTaskRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
