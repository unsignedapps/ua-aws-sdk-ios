...
@class UAEC2Filter, UAEC2DescribeImagesResponse;

typedef void(^UAEC2DescribeImagesRequestCompletionBlock)(UAEC2DescribeImagesResponse *response, NSError *error);
typedef BOOL(^UAEC2DescribeImagesRequestShouldContinueWaitingBlock)(UAEC2DescribeImagesResponse *response, NSError *error);

@interface UAEC2DescribeImagesRequest : UAEC2Request
...
// @property (nonatomic, copy) UAEC2DescribeImagesRequestCompletionBlock UA_RequestCompletionBlock;
...
/**
 * Adds a Owner to the owners property.
 *
 * This will initialise owners with an empty mutable array if necessary.
**/
- (void)addOwner:(NSString *)owner;
/**
 * Adds a ExecutableUser to the executableUsers property.
 *
 * This will initialise executableUsers with an empty mutable array if necessary.
**/
