//
//  UAEC2DescribeAvailabilityZonesRequest.h
//  AWS iOS SDK
//
...
@class UAEC2Filter, UAEC2DescribeAvailabilityZonesResponse;

typedef void(^UAEC2DescribeAvailabilityZonesRequestCompletionBlock)(UAEC2DescribeAvailabilityZonesResponse *response, NSError *error);
typedef BOOL(^UAEC2DescribeAvailabilityZonesRequestShouldContinueWaitingBlock)(UAEC2DescribeAvailabilityZonesResponse *response, NSError *error);

@interface UAEC2DescribeAvailabilityZonesRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic, strong) NSMutableArray *zoneNames;
@property (nonatomic, strong) NSMutableArray *filters;
// @property (nonatomic, copy) UAEC2DescribeAvailabilityZonesRequestCompletionBlock UA_RequestCompletionBlock;
