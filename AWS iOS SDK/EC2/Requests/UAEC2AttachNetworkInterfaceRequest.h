//
//  UAEC2AttachNetworkInterfaceRequest.h
//  AWS iOS SDK
//
...
@class UAEC2AttachNetworkInterfaceResponse;

typedef void(^UAEC2AttachNetworkInterfaceRequestCompletionBlock)(UAEC2AttachNetworkInterfaceResponse *response, NSError *error);
typedef BOOL(^UAEC2AttachNetworkInterfaceRequestShouldContinueWaitingBlock)(UAEC2AttachNetworkInterfaceResponse *response, NSError *error);

@interface UAEC2AttachNetworkInterfaceRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic, copy) NSString *networkInterfaceID;
@property (nonatomic, copy) NSString *instanceID;
@property (nonatomic, strong) NSNumber *deviceIndex;
// @property (nonatomic, copy) UAEC2AttachNetworkInterfaceRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2AttachNetworkInterfaceRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
