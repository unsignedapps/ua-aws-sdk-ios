//
//  UAEC2EnableVGWRoutePropagationRequest.h
//  AWS iOS SDK
//
...
@class UAEC2EnableVGWRoutePropagation;

typedef void(^UAEC2EnableVGWRoutePropagationRequestCompletionBlock)(UAEC2EnableVGWRoutePropagation *response, NSError *error);
typedef BOOL(^UAEC2EnableVGWRoutePropagationRequestShouldContinueWaitingBlock)(UAEC2EnableVGWRoutePropagation *response, NSError *error);

@interface UAEC2EnableVGWRoutePropagationRequest : UAEC2Request

@property (nonatomic, copy) NSString *routeTableID;
@property (nonatomic, copy) NSString *gatewayID;
// @property (nonatomic, copy) UAEC2EnableVGWRoutePropagationRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2EnableVGWRoutePropagationRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
