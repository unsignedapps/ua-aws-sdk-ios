//
//  UAEC2DescribeExportTasksRequest.h
//  AWS iOS SDK
//
...
@class UAEC2DescribeExportTasksResponse;

typedef void(^UAEC2DescribeExportTasksRequestCompletionBlock)(UAEC2DescribeExportTasksResponse *response, NSError *error);
typedef BOOL(^UAEC2DescribeExportTasksRequestShouldContinueWaitingBlock)(UAEC2DescribeExportTasksResponse *response, NSError *error);

@interface UAEC2DescribeExportTasksRequest : UAEC2Request

@property (nonatomic, strong) NSMutableArray *exportTaskIDs;
// @property (nonatomic, copy) UAEC2DescribeExportTasksRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2DescribeExportTasksRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
