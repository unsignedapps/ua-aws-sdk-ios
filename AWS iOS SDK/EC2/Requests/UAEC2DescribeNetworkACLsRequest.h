//
//  UAEC2DescribeNetworkACLsRequest.h
//  AWS iOS SDK
//
...
@class UAEC2Filter, UAEC2DescribeNetworkACLsResponse;

typedef void(^UAEC2DescribeNetworkACLsRequestCompletionBlock)(UAEC2DescribeNetworkACLsResponse *response, NSError *error);
typedef BOOL(^UAEC2DescribeNetworkACLsRequestShouldContinueWaitingBlock)(UAEC2DescribeNetworkACLsResponse *response, NSError *error);

@interface UAEC2DescribeNetworkACLsRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic, strong) NSMutableArray *networkACLIDs;
@property (nonatomic, strong) NSMutableArray *filters;
// @property (nonatomic, copy) UAEC2DescribeNetworkACLsRequestCompletionBlock UA_RequestCompletionBlock;
