...
@class UAEC2ReleaseAddressResponse;

typedef void(^UAEC2ReleaseAddressRequestCompletionBlock)(UAEC2ReleaseAddressResponse *response, NSError *error);
typedef BOOL(^UAEC2ReleaseAddressRequestShouldContinueWaitingBlock)(UAEC2ReleaseAddressResponse *response, NSError *error);

@interface UAEC2ReleaseAddressRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic, copy) NSString *publicIP;
@property (nonatomic, copy) NSString *allocationID;
// @property (nonatomic, copy) UAEC2ReleaseAddressRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2ReleaseAddressRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
