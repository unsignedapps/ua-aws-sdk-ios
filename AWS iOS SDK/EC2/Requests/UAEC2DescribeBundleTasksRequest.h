//
//  UAEC2DescribeBundleTasksRequest.h
//  AWS iOS SDK
//
...
@class UAEC2Filter, UAEC2DescribeBundleTasksResponse;

typedef void(^UAEC2DescribeBundleTasksRequestCompletionBlock)(UAEC2DescribeBundleTasksResponse *response, NSError *error);
typedef BOOL(^UAEC2DescribeBundleTasksRequestShouldContinueWaitingBlock)(UAEC2DescribeBundleTasksResponse *response, NSError *error);

@interface UAEC2DescribeBundleTasksRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic, strong) NSMutableArray *bundleIDs;
@property (nonatomic, strong) NSMutableArray *filters;
// @property (nonatomic, copy) UAEC2DescribeBundleTasksRequestCompletionBlock UA_RequestCompletionBlock;
