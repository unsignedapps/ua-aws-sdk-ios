//
//  UAEC2ReplaceNetworkACLEntryRequest.h
//  AWS iOS SDK
//
...
@class UAEC2IcmpTypeCode, UAEC2PortRange, UAEC2ReplaceNetworkACLEntryResponse;

typedef void(^UAEC2ReplaceNetworkACLEntryRequestCompletionBlock)(UAEC2ReplaceNetworkACLEntryResponse *response, NSError *error);
typedef BOOL(^UAEC2ReplaceNetworkACLEntryRequestShouldContinueWaitingBlock)(UAEC2ReplaceNetworkACLEntryResponse *response, NSError *error);

@interface UAEC2ReplaceNetworkACLEntryRequest : UAEC2Request
...
// @property (nonatomic, copy) UAEC2ReplaceNetworkACLEntryRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2ReplaceNetworkACLEntryRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
