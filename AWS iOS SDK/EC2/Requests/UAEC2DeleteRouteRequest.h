...
@class UAEC2DeleteRouteResponse;

typedef void(^UAEC2DeleteRouteRequestCompletionBlock)(UAEC2DeleteRouteResponse *response, NSError *error);
typedef BOOL(^UAEC2DeleteRouteRequestShouldContinueWaitingBlock)(UAEC2DeleteRouteResponse *response, NSError *error);

@interface UAEC2DeleteRouteRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic, copy) NSString *routeTableID;
@property (nonatomic, copy) NSString *destinationCidrBlock;
// @property (nonatomic, copy) UAEC2DeleteRouteRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2DeleteRouteRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
