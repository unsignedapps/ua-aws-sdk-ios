//
//  UAEC2UnmonitorInstancesRequest.h
//  AWS iOS SDK
//
...
@class UAEC2UnmonitorInstancesResponse;

typedef void(^UAEC2UnmonitorInstancesRequestCompletionBlock)(UAEC2UnmonitorInstancesResponse *response, NSError *error);
typedef BOOL(^UAEC2UnmonitorInstancesRequestShouldContinueWaitingBlock)(UAEC2UnmonitorInstancesResponse *response, NSError *error);

@interface UAEC2UnmonitorInstancesRequest : UAEC2Request

@property (nonatomic) BOOL dryRun;
@property (nonatomic, strong) NSMutableArray *instanceIDs;
// @property (nonatomic, copy) UAEC2UnmonitorInstancesRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAEC2UnmonitorInstancesRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
