//
//  UAEC2DescribeVPCClassicLinkResponse.m
//  AWS iOS SDK
//
...
@implementation UAEC2DescribeVPCClassicLinkResponse
...
{
    return @"./ec2:DescribeVpcClassicLinkResponse/";
}
...
{
  return [NSValueTransformer UAMTL_XMLArrayTransformerWithModelClass:[UAEC2VPCClassicLink class]];
}
