...
#import "UAAWSRequest+MTLModel.h"
...
@implementation UAAWSRequest (MTLModel)
...
- (void)mergeValuesForKeysFromModel:(NSObject<MTLModel> *)model {
...
- (BOOL)isEqual:(NSObject<MTLModel> *)model {
