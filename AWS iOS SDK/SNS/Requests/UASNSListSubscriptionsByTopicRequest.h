//
//  UASNSListSubscriptionsByTopicRequest.h
//  AWS iOS SDK
//
...
@class UASNSListSubscriptionsByTopicResponse;

typedef void(^UASNSListSubscriptionsByTopicRequestCompletionBlock)(UASNSListSubscriptionsByTopicResponse *response, NSError *error);
typedef BOOL(^UASNSListSubscriptionsByTopicRequestShouldContinueWaitingBlock)(UASNSListSubscriptionsByTopicResponse *response, NSError *error);

@interface UASNSListSubscriptionsByTopicRequest : UASNSRequest
