//
//  UASNSSetTopicAttributesRequest.h
//  AWS iOS SDK
//
...
@class UASNSSetTopicAttributesResponse;

typedef void(^UASNSSetTopicAttributesRequestCompletionBlock)(UASNSSetTopicAttributesResponse *response, NSError *error);
typedef BOOL(^UASNSSetTopicAttributesRequestShouldContinueWaitingBlock)(UASNSSetTopicAttributesResponse *response, NSError *error);

@interface UASNSSetTopicAttributesRequest : UASNSRequest
