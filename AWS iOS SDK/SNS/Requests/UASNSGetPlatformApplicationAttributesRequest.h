//
//  UASNSGetPlatformApplicationAttributesRequest.h
//  AWS iOS SDK
//
...
@class UASNSGetPlatformApplicationAttributesResponse;

typedef void(^UASNSGetPlatformApplicationAttributesRequestCompletionBlock)(UASNSGetPlatformApplicationAttributesResponse *response, NSError *error);
typedef BOOL(^UASNSGetPlatformApplicationAttributesRequestShouldContinueWaitingBlock)(UASNSGetPlatformApplicationAttributesResponse *response, NSError *error);
