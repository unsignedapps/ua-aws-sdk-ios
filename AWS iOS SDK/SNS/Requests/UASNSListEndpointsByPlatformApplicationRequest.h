//
//  UASNSListEndpointsByPlatformApplicationRequest.h
//  AWS iOS SDK
//
...
@class UASNSListEndpointsByPlatformApplicationResponse;

typedef void(^UASNSListEndpointsByPlatformApplicationRequestCompletionBlock)(UASNSListEndpointsByPlatformApplicationResponse *response, NSError *error);
typedef BOOL(^UASNSListEndpointsByPlatformApplicationRequestShouldContinueWaitingBlock)(UASNSListEndpointsByPlatformApplicationResponse *response, NSError *error);

@interface UASNSListEndpointsByPlatformApplicationRequest : UASNSRequest
