...
@class UASNSCreateTopicResponse;

typedef void(^UASNSCreateTopicRequestCompletionBlock)(UASNSCreateTopicResponse *response, NSError *error);
typedef BOOL(^UASNSCreateTopicRequestShouldContinueWaitingBlock)(UASNSCreateTopicResponse *response, NSError *error);
