...
@class UASNSListTopicsResponse;

typedef void(^UASNSListTopicsRequestCompletionBlock)(UASNSListTopicsResponse *response, NSError *error);
typedef BOOL(^UASNSListTopicsRequestShouldContinueWaitingBlock)(UASNSListTopicsResponse *response, NSError *error);

@interface UASNSListTopicsRequest : UASNSRequest

@property (nonatomic, copy) NSString *nextToken;
// @property (nonatomic, copy) UASNSListTopicsRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UASNSListTopicsRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
