...
@class UASNSDeleteTopicResponse;

typedef void(^UASNSDeleteTopicRequestCompletionBlock)(UASNSDeleteTopicResponse *response, NSError *error);
typedef BOOL(^UASNSDeleteTopicRequestShouldContinueWaitingBlock)(UASNSDeleteTopicResponse *response, NSError *error);
