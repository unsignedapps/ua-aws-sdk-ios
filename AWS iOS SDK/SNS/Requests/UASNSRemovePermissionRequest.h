//
//  UASNSRemovePermissionRequest.h
//  AWS iOS SDK
//
...
@class UASNSRemovePermissionResponse;

typedef void(^UASNSRemovePermissionRequestCompletionBlock)(UASNSRemovePermissionResponse *response, NSError *error);
typedef BOOL(^UASNSRemovePermissionRequestShouldContinueWaitingBlock)(UASNSRemovePermissionResponse *response, NSError *error);

@interface UASNSRemovePermissionRequest : UASNSRequest
