//
//  UASNSSetSubscriptionAttributesRequest.h
//  AWS iOS SDK
//
...
@class UASNSSetSubscriptionAttributesResponse;

typedef void(^UASNSSetSubscriptionAttributesRequestCompletionBlock)(UASNSSetSubscriptionAttributesResponse *response, NSError *error);
typedef BOOL(^UASNSSetSubscriptionAttributesRequestShouldContinueWaitingBlock)(UASNSSetSubscriptionAttributesResponse *response, NSError *error);

@interface UASNSSetSubscriptionAttributesRequest : UASNSRequest
