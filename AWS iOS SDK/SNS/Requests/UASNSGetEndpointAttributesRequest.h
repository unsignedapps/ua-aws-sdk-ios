//
//  UASNSGetEndpointAttributesRequest.h
//  AWS iOS SDK
//
...
@class UASNSGetEndpointAttributesResponse;

typedef void(^UASNSGetEndpointAttributesRequestCompletionBlock)(UASNSGetEndpointAttributesResponse *response, NSError *error);
typedef BOOL(^UASNSGetEndpointAttributesRequestShouldContinueWaitingBlock)(UASNSGetEndpointAttributesResponse *response, NSError *error);
