...
@class UASNSUnsubscribeResponse;

typedef void(^UASNSUnsubscribeRequestCompletionBlock)(UASNSUnsubscribeResponse *response, NSError *error);
typedef BOOL(^UASNSUnsubscribeRequestShouldContinueWaitingBlock)(UASNSUnsubscribeResponse *response, NSError *error);
