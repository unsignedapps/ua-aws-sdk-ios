...
@class UASNSDeleteEndpointResponse;

typedef void(^UASNSDeleteEndpointRequestCompletionBlock)(UASNSDeleteEndpointResponse *response, NSError *error);
typedef BOOL(^UASNSDeleteEndpointRequestShouldContinueWaitingBlock)(UASNSDeleteEndpointResponse *response, NSError *error);
