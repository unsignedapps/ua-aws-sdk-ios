...
@class UASNSSubscribeResponse;

typedef void(^UASNSSubscribeRequestCompletionBlock)(UASNSSubscribeResponse *response, NSError *error);
typedef BOOL(^UASNSSubscribeRequestShouldContinueWaitingBlock)(UASNSSubscribeResponse *response, NSError *error);
