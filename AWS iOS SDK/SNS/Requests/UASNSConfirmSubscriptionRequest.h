//
//  UASNSConfirmSubscriptionRequest.h
//  AWS iOS SDK
//
...
@class UASNSConfirmSubscriptionResponse;

typedef void(^UASNSConfirmSubscriptionRequestCompletionBlock)(UASNSConfirmSubscriptionResponse *response, NSError *error);
typedef BOOL(^UASNSConfirmSubscriptionRequestShouldContinueWaitingBlock)(UASNSConfirmSubscriptionResponse *response, NSError *error);

@interface UASNSConfirmSubscriptionRequest : UASNSRequest
