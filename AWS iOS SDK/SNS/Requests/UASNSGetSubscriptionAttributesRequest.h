//
//  UASNSGetSubscriptionAttributesRequest.h
//  AWS iOS SDK
//
...
@class UASNSGetSubscriptionAttributesResponse;

typedef void(^UASNSGetSubscriptionAttributesRequestCompletionBlock)(UASNSGetSubscriptionAttributesResponse *response, NSError *error);
typedef BOOL(^UASNSGetSubscriptionAttributesRequestShouldContinueWaitingBlock)(UASNSGetSubscriptionAttributesResponse *response, NSError *error);

@interface UASNSGetSubscriptionAttributesRequest : UASNSRequest

@property (nonatomic, copy) NSString *subscriptionARN;
// @property (nonatomic, copy) UASNSGetSubscriptionAttributesRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UASNSGetSubscriptionAttributesRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
