//
//  UASNSSetEndpointAttributesRequest.h
//  AWS iOS SDK
//
...
@class UASNSSetEndpointAttributesResponse;

typedef void(^UASNSSetEndpointAttributesRequestCompletionBlock)(UASNSSetEndpointAttributesResponse *response, NSError *error);
typedef BOOL(^UASNSSetEndpointAttributesRequestShouldContinueWaitingBlock)(UASNSSetEndpointAttributesResponse *response, NSError *error);

@interface UASNSSetEndpointAttributesRequest : UASNSRequest
