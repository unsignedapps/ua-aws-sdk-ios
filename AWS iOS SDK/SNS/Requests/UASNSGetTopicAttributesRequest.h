//
//  UASNSGetTopicAttributesRequest.h
//  AWS iOS SDK
//
...
@class UASNSGetTopicAttributesResponse;

typedef void(^UASNSGetTopicAttributesRequestCompletionBlock)(UASNSGetTopicAttributesResponse *response, NSError *error);
typedef BOOL(^UASNSGetTopicAttributesRequestShouldContinueWaitingBlock)(UASNSGetTopicAttributesResponse *response, NSError *error);
