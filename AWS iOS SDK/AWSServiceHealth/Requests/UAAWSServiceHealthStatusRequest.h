//
//  UAAWSServiceHealthStatusRequest.h
//  AWS iOS SDK
//
...
@class UAAWSServiceHealthStatusResponse;

typedef void(^UAAWSServiceHealthStatusRequestCompletionBlock)(UAAWSServiceHealthStatusResponse *response, NSError *error);
typedef BOOL(^UAAWSServiceHealthStatusRequestShouldContinueWaitingBlock)(UAAWSServiceHealthStatusResponse *response, NSError *error);

@interface UAAWSServiceHealthStatusRequest : UAAWSServiceHealthRequest
