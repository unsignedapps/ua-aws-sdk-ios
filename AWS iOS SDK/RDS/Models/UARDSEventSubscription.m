...
@implementation UARDSEventSubscription
...
{
    return [NSValueTransformer UA_ENUMTransformerWithValues:@[ @(UARDSEventSubscriptionStatusCreating), @(UARDSEventSubscriptionStatusModifying), @(UARDSEventSubscriptionStatusDeleting), @(UARDSEventSubscriptionStatusActive), @(UARDSEventSubscriptionStatusNoPermission), @(UARDSEventSubscriptionStatusTopicNotExist) ]
                                               stringValues:@[ @"creating", @"modifying", @"deleting", @"active", @"no-permission", @"topic-not-exist" ]
                                               unknownValue:@(UARDSEventSubscriptionStatusUnknown)];
}
