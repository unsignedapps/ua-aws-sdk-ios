...
@class UARDSTag, UARDSDBSnapshotResponse;

typedef void(^UARDSCopyDBSnapshotRequestCompletionBlock)(UARDSDBSnapshotResponse *response, NSError *error);
typedef BOOL(^UARDSCopyDBSnapshotRequestShouldContinueWaitingBlock)(UARDSDBSnapshotResponse *response, NSError *error);

@interface UARDSCopyDBSnapshotRequest : UARDSRequest

@property (nonatomic, copy) NSString *sourceDBSnapshotIdentifier;
@property (nonatomic, copy) NSString *targetDBSnapshotIdentifier;
