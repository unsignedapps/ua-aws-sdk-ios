//
//  UARDSDescribeDBLogFilesRequest.h
//  AWS iOS SDK
//
...
@class UARDSFilter, UARDSDescribeDBLogFilesResponse;

typedef void(^UARDSDescribeDBLogFilesRequestCompletionBlock)(UARDSDescribeDBLogFilesResponse *response, NSError *error);
typedef BOOL(^UARDSDescribeDBLogFilesRequestShouldContinueWaitingBlock)(UARDSDescribeDBLogFilesResponse *response, NSError *error);

@interface UARDSDescribeDBLogFilesRequest : UARDSRequest

@property (nonatomic, copy) NSString *dBInstanceIdentifier;
@property (nonatomic, copy) NSString *filenameContains;
@property (nonatomic, strong) NSNumber *fileLastWritten;
