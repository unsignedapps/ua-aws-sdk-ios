//
//  UARDSDescribeEventCategoriesRequest.h
//  AWS iOS SDK
//
...
@class UARDSFilter, UARDSEventCategoriesMessage;

typedef void(^UARDSDescribeEventCategoriesRequestCompletionBlock)(UARDSEventCategoriesMessage *response, NSError *error);
typedef BOOL(^UARDSDescribeEventCategoriesRequestShouldContinueWaitingBlock)(UARDSEventCategoriesMessage *response, NSError *error);

@interface UARDSDescribeEventCategoriesRequest : UARDSRequest
