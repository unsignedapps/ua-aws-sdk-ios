//
//  UARDSDescribeEngineDefaultParametersRequest.h
//  AWS iOS SDK
//
...
@class UARDSFilter, UARDSEngineDefaultsResponse;

typedef void(^UARDSDescribeEngineDefaultParametersRequestCompletionBlock)(UARDSEngineDefaultsResponse *response, NSError *error);
typedef BOOL(^UARDSDescribeEngineDefaultParametersRequestShouldContinueWaitingBlock)(UARDSEngineDefaultsResponse *response, NSError *error);

@interface UARDSDescribeEngineDefaultParametersRequest : UARDSRequest
