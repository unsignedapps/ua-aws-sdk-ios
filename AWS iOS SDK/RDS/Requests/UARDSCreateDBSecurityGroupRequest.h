//
//  UARDSCreateDBSecurityGroupRequest.h
//  AWS iOS SDK
//
...
@class UARDSTag, UARDSDBSecurityGroupResponse;

typedef void(^UARDSCreateDBSecurityGroupRequestCompletionBlock)(UARDSDBSecurityGroupResponse *response, NSError *error);
typedef BOOL(^UARDSCreateDBSecurityGroupRequestShouldContinueWaitingBlock)(UARDSDBSecurityGroupResponse *response, NSError *error);

@interface UARDSCreateDBSecurityGroupRequest : UARDSRequest
