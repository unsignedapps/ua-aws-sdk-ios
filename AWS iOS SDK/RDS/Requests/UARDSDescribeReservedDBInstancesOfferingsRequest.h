//
//  UARDSDescribeReservedDBInstancesOfferingsRequest.h
//  AWS iOS SDK
//
...
@class UARDSFilter, UARDSReservedDBInstancesOfferingMessage;

typedef void(^UARDSDescribeReservedDBInstancesOfferingsRequestCompletionBlock)(UARDSReservedDBInstancesOfferingMessage *response, NSError *error);
typedef BOOL(^UARDSDescribeReservedDBInstancesOfferingsRequestShouldContinueWaitingBlock)(UARDSReservedDBInstancesOfferingMessage *response, NSError *error);

@interface UARDSDescribeReservedDBInstancesOfferingsRequest : UARDSRequest
