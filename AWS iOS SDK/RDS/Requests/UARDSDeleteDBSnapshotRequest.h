//
//  UARDSDeleteDBSnapshotRequest.h
//  AWS iOS SDK
//
...
@class UARDSDBSnapshotResponse;

typedef void(^UARDSDeleteDBSnapshotRequestCompletionBlock)(UARDSDBSnapshotResponse *response, NSError *error);
typedef BOOL(^UARDSDeleteDBSnapshotRequestShouldContinueWaitingBlock)(UARDSDBSnapshotResponse *response, NSError *error);

@interface UARDSDeleteDBSnapshotRequest : UARDSRequest
