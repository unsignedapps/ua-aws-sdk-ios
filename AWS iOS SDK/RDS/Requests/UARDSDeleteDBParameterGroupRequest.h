//
//  UARDSDeleteDBParameterGroupRequest.h
//  AWS iOS SDK
//
...
@class UARDSDeleteDBParameterGroupResponse;

typedef void(^UARDSDeleteDBParameterGroupRequestCompletionBlock)(UARDSDeleteDBParameterGroupResponse *response, NSError *error);
typedef BOOL(^UARDSDeleteDBParameterGroupRequestShouldContinueWaitingBlock)(UARDSDeleteDBParameterGroupResponse *response, NSError *error);

@interface UARDSDeleteDBParameterGroupRequest : UARDSRequest
