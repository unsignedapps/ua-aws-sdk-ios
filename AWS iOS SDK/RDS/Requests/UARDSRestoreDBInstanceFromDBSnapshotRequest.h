//
//  UARDSRestoreDBInstanceFromDBSnapshotRequest.h
//  AWS iOS SDK
//
...
typedef void(^UARDSRestoreDBInstanceFromDBSnapshotRequestCompletionBlock)(UARDSDBInstanceResponse *response, NSError *error);
typedef BOOL(^UARDSRestoreDBInstanceFromDBSnapshotRequestShouldContinueWaitingBlock)(UARDSDBInstanceResponse *response, NSError *error);

@interface UARDSRestoreDBInstanceFromDBSnapshotRequest : UARDSRequest
