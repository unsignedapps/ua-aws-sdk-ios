//
//  UARDSCreateDBSnapshotRequest.h
//  AWS iOS SDK
//
...
typedef void(^UARDSCreateDBSnapshotRequestCompletionBlock)(UARDSDBSnapshotResponse *response, NSError *error);
typedef BOOL(^UARDSCreateDBSnapshotRequestShouldContinueWaitingBlock)(UARDSDBSnapshotResponse *response, NSError *error);

@interface UARDSCreateDBSnapshotRequest : UARDSRequest
