//
//  UARDSAuthorizeDBSecurityGroupIngressRequest.h
//  AWS iOS SDK
//
...
@class UARDSDBSecurityGroupResponse;

typedef void(^UARDSAuthorizeDBSecurityGroupIngressRequestCompletionBlock)(UARDSDBSecurityGroupResponse *response, NSError *error);
typedef BOOL(^UARDSAuthorizeDBSecurityGroupIngressRequestShouldContinueWaitingBlock)(UARDSDBSecurityGroupResponse *response, NSError *error);

@interface UARDSAuthorizeDBSecurityGroupIngressRequest : UARDSRequest
