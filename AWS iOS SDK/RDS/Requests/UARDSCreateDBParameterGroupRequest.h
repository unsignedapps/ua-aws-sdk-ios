//
//  UARDSCreateDBParameterGroupRequest.h
//  AWS iOS SDK
//
...
typedef void(^UARDSCreateDBParameterGroupRequestCompletionBlock)(UARDSDBParameterGroupResponse *response, NSError *error);
typedef BOOL(^UARDSCreateDBParameterGroupRequestShouldContinueWaitingBlock)(UARDSDBParameterGroupResponse *response, NSError *error);

@interface UARDSCreateDBParameterGroupRequest : UARDSRequest
