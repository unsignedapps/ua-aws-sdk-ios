//
//  UARDSCreateEventSubscriptionRequest.h
//  AWS iOS SDK
//
...
@class UARDSTag, UARDSEventSubscriptionResponse;

typedef void(^UARDSCreateEventSubscriptionRequestCompletionBlock)(UARDSEventSubscriptionResponse *response, NSError *error);
typedef BOOL(^UARDSCreateEventSubscriptionRequestShouldContinueWaitingBlock)(UARDSEventSubscriptionResponse *response, NSError *error);

@interface UARDSCreateEventSubscriptionRequest : UARDSRequest
...
@property (nonatomic, strong) NSMutableArray *sourceIDs;
 ...
 * Retrieves the NSString at the specified index.
**/
- (NSString *)sourceIDAtIndex:(NSUInteger)index;
...
/**
 * Adds a SourceID to the sourceIDs property.
 *
 * This will initialise sourceIDs with an empty mutable array if necessary.
**/
- (void)addSourceID:(NSString *)sourceID;
/**
