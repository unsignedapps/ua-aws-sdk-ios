//
//  UARDSRemoveSourceIdentifierFromSubscriptionRequest.h
//  AWS iOS SDK
//
...
typedef void(^UARDSRemoveSourceIdentifierFromSubscriptionRequestCompletionBlock)(UARDSEventSubscriptionResponse *response, NSError *error);
typedef BOOL(^UARDSRemoveSourceIdentifierFromSubscriptionRequestShouldContinueWaitingBlock)(UARDSEventSubscriptionResponse *response, NSError *error);

@interface UARDSRemoveSourceIdentifierFromSubscriptionRequest : UARDSRequest
