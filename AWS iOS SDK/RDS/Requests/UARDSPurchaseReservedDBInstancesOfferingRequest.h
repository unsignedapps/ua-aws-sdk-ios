//
//  UARDSPurchaseReservedDBInstancesOfferingRequest.h
//  AWS iOS SDK
//
...
@class UARDSTag, UARDSReservedDBInstanceResponse;

typedef void(^UARDSPurchaseReservedDBInstancesOfferingRequestCompletionBlock)(UARDSReservedDBInstanceResponse *response, NSError *error);
typedef BOOL(^UARDSPurchaseReservedDBInstancesOfferingRequestShouldContinueWaitingBlock)(UARDSReservedDBInstanceResponse *response, NSError *error);

@interface UARDSPurchaseReservedDBInstancesOfferingRequest : UARDSRequest
