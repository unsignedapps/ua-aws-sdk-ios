//
//  UARDSModifyDBInstanceRequest.h
//  AWS iOS SDK
//
...
@class UARDSDBInstanceResponse;

typedef void(^UARDSModifyDBInstanceRequestCompletionBlock)(UARDSDBInstanceResponse *response, NSError *error);
typedef BOOL(^UARDSModifyDBInstanceRequestShouldContinueWaitingBlock)(UARDSDBInstanceResponse *response, NSError *error);

@interface UARDSModifyDBInstanceRequest : UARDSRequest
...
@property (nonatomic) BOOL allowMajorVersionUpgrade;
...
@property (nonatomic, copy) NSString *modifiedDBInstanceIdentifier;
