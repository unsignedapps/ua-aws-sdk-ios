//
//  UARDSRebootDBInstanceRequest.h
//  AWS iOS SDK
//
...
typedef void(^UARDSRebootDBInstanceRequestCompletionBlock)(UARDSDBInstanceResponse *response, NSError *error);
typedef BOOL(^UARDSRebootDBInstanceRequestShouldContinueWaitingBlock)(UARDSDBInstanceResponse *response, NSError *error);

@interface UARDSRebootDBInstanceRequest : UARDSRequest

@property (nonatomic, copy) NSString *dBInstanceIdentifier;
@property (nonatomic) BOOL forceFailover;
