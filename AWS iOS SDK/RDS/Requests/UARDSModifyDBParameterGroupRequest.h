//
//  UARDSModifyDBParameterGroupRequest.h
//  AWS iOS SDK
//
...
typedef void(^UARDSModifyDBParameterGroupRequestCompletionBlock)(UARDSDBParameterGroupNameMessage *response, NSError *error);
typedef BOOL(^UARDSModifyDBParameterGroupRequestShouldContinueWaitingBlock)(UARDSDBParameterGroupNameMessage *response, NSError *error);

@interface UARDSModifyDBParameterGroupRequest : UARDSRequest
