//
//  UARDSDescribeOrderableDBInstanceOptionsRequest.h
//  AWS iOS SDK
//
...
@class UARDSFilter, UARDSOrderableDBInstanceOptionsMessage;

typedef void(^UARDSDescribeOrderableDBInstanceOptionsRequestCompletionBlock)(UARDSOrderableDBInstanceOptionsMessage *response, NSError *error);
typedef BOOL(^UARDSDescribeOrderableDBInstanceOptionsRequestShouldContinueWaitingBlock)(UARDSOrderableDBInstanceOptionsMessage *response, NSError *error);

@interface UARDSDescribeOrderableDBInstanceOptionsRequest : UARDSRequest
