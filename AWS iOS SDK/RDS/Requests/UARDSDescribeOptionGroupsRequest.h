//
//  UARDSDescribeOptionGroupsRequest.h
//  AWS iOS SDK
//
...
@class UARDSFilter, UARDSOptionGroups;

typedef void(^UARDSDescribeOptionGroupsRequestCompletionBlock)(UARDSOptionGroups *response, NSError *error);
typedef BOOL(^UARDSDescribeOptionGroupsRequestShouldContinueWaitingBlock)(UARDSOptionGroups *response, NSError *error);

@interface UARDSDescribeOptionGroupsRequest : UARDSRequest
