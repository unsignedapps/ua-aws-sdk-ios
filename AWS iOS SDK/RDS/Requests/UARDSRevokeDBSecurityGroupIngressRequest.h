//
//  UARDSRevokeDBSecurityGroupIngressRequest.h
//  AWS iOS SDK
//
...
typedef void(^UARDSRevokeDBSecurityGroupIngressRequestCompletionBlock)(UARDSDBSecurityGroupResponse *response, NSError *error);
typedef BOOL(^UARDSRevokeDBSecurityGroupIngressRequestShouldContinueWaitingBlock)(UARDSDBSecurityGroupResponse *response, NSError *error);

@interface UARDSRevokeDBSecurityGroupIngressRequest : UARDSRequest
