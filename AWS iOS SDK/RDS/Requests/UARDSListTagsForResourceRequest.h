//
//  UARDSListTagsForResourceRequest.h
//  AWS iOS SDK
//
...
@class UARDSFilter, UARDSTagListMessage;

typedef void(^UARDSListTagsForResourceRequestCompletionBlock)(UARDSTagListMessage *response, NSError *error);
typedef BOOL(^UARDSListTagsForResourceRequestShouldContinueWaitingBlock)(UARDSTagListMessage *response, NSError *error);

@interface UARDSListTagsForResourceRequest : UARDSRequest
