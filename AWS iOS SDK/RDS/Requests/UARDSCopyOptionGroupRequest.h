...
@class UARDSTag, UARDSOptionGroupResponse;

typedef void(^UARDSCopyOptionGroupRequestCompletionBlock)(UARDSOptionGroupResponse *response, NSError *error);
typedef BOOL(^UARDSCopyOptionGroupRequestShouldContinueWaitingBlock)(UARDSOptionGroupResponse *response, NSError *error);

@interface UARDSCopyOptionGroupRequest : UARDSRequest

@property (nonatomic, copy) NSString *sourceOptionGroupIdentifier;
@property (nonatomic, copy) NSString *targetOptionGroupIdentifier;
@property (nonatomic, copy) NSString *targetOptionGroupDescription;
