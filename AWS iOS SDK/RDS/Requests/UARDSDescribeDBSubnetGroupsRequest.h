//
//  UARDSDescribeDBSubnetGroupsRequest.h
//  AWS iOS SDK
//
...
@class UARDSFilter, UARDSDBSubnetGroupMessage;

typedef void(^UARDSDescribeDBSubnetGroupsRequestCompletionBlock)(UARDSDBSubnetGroupMessage *response, NSError *error);
typedef BOOL(^UARDSDescribeDBSubnetGroupsRequestShouldContinueWaitingBlock)(UARDSDBSubnetGroupMessage *response, NSError *error);

@interface UARDSDescribeDBSubnetGroupsRequest : UARDSRequest
