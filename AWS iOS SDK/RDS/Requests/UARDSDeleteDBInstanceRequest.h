//
//  UARDSDeleteDBInstanceRequest.h
//  AWS iOS SDK
//
...
typedef void(^UARDSDeleteDBInstanceRequestCompletionBlock)(UARDSDBInstanceResponse *response, NSError *error);
typedef BOOL(^UARDSDeleteDBInstanceRequestShouldContinueWaitingBlock)(UARDSDBInstanceResponse *response, NSError *error);

@interface UARDSDeleteDBInstanceRequest : UARDSRequest

@property (nonatomic, copy) NSString *dBInstanceIdentifier;
@property (nonatomic) BOOL skipFinalSnapshot;
@property (nonatomic, copy) NSString *finalDBSnapshotIdentifier;
