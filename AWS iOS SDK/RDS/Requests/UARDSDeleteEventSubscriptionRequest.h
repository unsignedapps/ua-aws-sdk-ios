//
//  UARDSDeleteEventSubscriptionRequest.h
//  AWS iOS SDK
//
...
typedef void(^UARDSDeleteEventSubscriptionRequestCompletionBlock)(UARDSEventSubscriptionResponse *response, NSError *error);
typedef BOOL(^UARDSDeleteEventSubscriptionRequestShouldContinueWaitingBlock)(UARDSEventSubscriptionResponse *response, NSError *error);

@interface UARDSDeleteEventSubscriptionRequest : UARDSRequest
