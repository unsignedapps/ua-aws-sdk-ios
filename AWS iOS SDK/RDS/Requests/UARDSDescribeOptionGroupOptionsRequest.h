//
//  UARDSDescribeOptionGroupOptionsRequest.h
//  AWS iOS SDK
//
...
@class UARDSFilter, UARDSOptionGroupOptionsMessage;

typedef void(^UARDSDescribeOptionGroupOptionsRequestCompletionBlock)(UARDSOptionGroupOptionsMessage *response, NSError *error);
typedef BOOL(^UARDSDescribeOptionGroupOptionsRequestShouldContinueWaitingBlock)(UARDSOptionGroupOptionsMessage *response, NSError *error);

@interface UARDSDescribeOptionGroupOptionsRequest : UARDSRequest
