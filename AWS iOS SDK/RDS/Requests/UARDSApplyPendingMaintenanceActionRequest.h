//
//  UARDSApplyPendingMaintenanceActionRequest.h
//  AWS iOS SDK
//
...
@class UARDSResourcePendingMaintenanceActionsResponse;

typedef void(^UARDSApplyPendingMaintenanceActionRequestCompletionBlock)(UARDSResourcePendingMaintenanceActionsResponse *response, NSError *error);
typedef BOOL(^UARDSApplyPendingMaintenanceActionRequestShouldContinueWaitingBlock)(UARDSResourcePendingMaintenanceActionsResponse *response, NSError *error);

@interface UARDSApplyPendingMaintenanceActionRequest : UARDSRequest

@property (nonatomic, copy) NSString *resourceIdentifier;
@property (nonatomic, copy) NSString *applyAction;
@property (nonatomic) UARDSOptInType optInType;
