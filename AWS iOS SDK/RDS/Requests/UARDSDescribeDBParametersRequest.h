//
//  UARDSDescribeDBParametersRequest.h
//  AWS iOS SDK
//
...
@class UARDSFilter, UARDSDBParameterGroupDetails;

typedef void(^UARDSDescribeDBParametersRequestCompletionBlock)(UARDSDBParameterGroupDetails *response, NSError *error);
typedef BOOL(^UARDSDescribeDBParametersRequestShouldContinueWaitingBlock)(UARDSDBParameterGroupDetails *response, NSError *error);

@interface UARDSDescribeDBParametersRequest : UARDSRequest
