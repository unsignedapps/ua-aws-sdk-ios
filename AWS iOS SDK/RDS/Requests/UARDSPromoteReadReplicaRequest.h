//
//  UARDSPromoteReadReplicaRequest.h
//  AWS iOS SDK
//
...
typedef void(^UARDSPromoteReadReplicaRequestCompletionBlock)(UARDSDBInstanceResponse *response, NSError *error);
typedef BOOL(^UARDSPromoteReadReplicaRequestShouldContinueWaitingBlock)(UARDSDBInstanceResponse *response, NSError *error);

@interface UARDSPromoteReadReplicaRequest : UARDSRequest
