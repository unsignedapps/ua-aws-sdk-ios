//
//  UARDSDescribeCertificatesRequest.h
//  AWS iOS SDK
//
...
@class UARDSFilter, UARDSCertificateMessage;

typedef void(^UARDSDescribeCertificatesRequestCompletionBlock)(UARDSCertificateMessage *response, NSError *error);
typedef BOOL(^UARDSDescribeCertificatesRequestShouldContinueWaitingBlock)(UARDSCertificateMessage *response, NSError *error);

@interface UARDSDescribeCertificatesRequest : UARDSRequest
