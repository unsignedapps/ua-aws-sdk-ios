//
//  UARDSDescribeAccountAttributesRequest.h
//  AWS iOS SDK
//
...
@class UARDSAccountAttributesMessage;

typedef void(^UARDSDescribeAccountAttributesRequestCompletionBlock)(UARDSAccountAttributesMessage *response, NSError *error);
typedef BOOL(^UARDSDescribeAccountAttributesRequestShouldContinueWaitingBlock)(UARDSAccountAttributesMessage *response, NSError *error);

@interface UARDSDescribeAccountAttributesRequest : UARDSRequest
