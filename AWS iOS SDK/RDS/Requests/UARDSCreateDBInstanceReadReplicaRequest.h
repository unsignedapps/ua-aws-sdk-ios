//
//  UARDSCreateDBInstanceReadReplicaRequest.h
//  AWS iOS SDK
//
...
typedef void(^UARDSCreateDBInstanceReadReplicaRequestCompletionBlock)(UARDSDBInstanceResponse *response, NSError *error);
typedef BOOL(^UARDSCreateDBInstanceReadReplicaRequestShouldContinueWaitingBlock)(UARDSDBInstanceResponse *response, NSError *error);

@interface UARDSCreateDBInstanceReadReplicaRequest : UARDSRequest
