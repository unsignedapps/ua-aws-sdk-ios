//
//  UARDSDeleteDBSecurityGroupRequest.h
//  AWS iOS SDK
//
...
@class UARDSDeleteDBSecurityGroupResponse;

typedef void(^UARDSDeleteDBSecurityGroupRequestCompletionBlock)(UARDSDeleteDBSecurityGroupResponse *response, NSError *error);
typedef BOOL(^UARDSDeleteDBSecurityGroupRequestShouldContinueWaitingBlock)(UARDSDeleteDBSecurityGroupResponse *response, NSError *error);

@interface UARDSDeleteDBSecurityGroupRequest : UARDSRequest
