//
//  UARDSModifyDBSubnetGroupRequest.h
//  AWS iOS SDK
//
...
@class UARDSDBSubnetGroupResponse;

typedef void(^UARDSModifyDBSubnetGroupRequestCompletionBlock)(UARDSDBSubnetGroupResponse *response, NSError *error);
typedef BOOL(^UARDSModifyDBSubnetGroupRequestShouldContinueWaitingBlock)(UARDSDBSubnetGroupResponse *response, NSError *error);

@interface UARDSModifyDBSubnetGroupRequest : UARDSRequest
