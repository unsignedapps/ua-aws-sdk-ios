//
//  UARDSDownloadDBLogFilePortionRequest.h
//  AWS iOS SDK
//
...
@class UARDSDownloadDBLogFilePortionDetails;

typedef void(^UARDSDownloadDBLogFilePortionRequestCompletionBlock)(UARDSDownloadDBLogFilePortionDetails *response, NSError *error);
typedef BOOL(^UARDSDownloadDBLogFilePortionRequestShouldContinueWaitingBlock)(UARDSDownloadDBLogFilePortionDetails *response, NSError *error);

@interface UARDSDownloadDBLogFilePortionRequest : UARDSRequest
