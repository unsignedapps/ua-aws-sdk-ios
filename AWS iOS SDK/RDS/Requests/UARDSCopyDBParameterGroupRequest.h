//
//  UARDSCopyDBParameterGroupRequest.h
//  AWS iOS SDK
//
...
@class UARDSTag, UARDSDBParameterGroupResponse;

typedef void(^UARDSCopyDBParameterGroupRequestCompletionBlock)(UARDSDBParameterGroupResponse *response, NSError *error);
typedef BOOL(^UARDSCopyDBParameterGroupRequestShouldContinueWaitingBlock)(UARDSDBParameterGroupResponse *response, NSError *error);

@interface UARDSCopyDBParameterGroupRequest : UARDSRequest

@property (nonatomic, copy) NSString *sourceDBParameterGroupIdentifier;
@property (nonatomic, copy) NSString *targetDBParameterGroupIdentifier;
@property (nonatomic, copy) NSString *targetDBParameterGroupDescription;
