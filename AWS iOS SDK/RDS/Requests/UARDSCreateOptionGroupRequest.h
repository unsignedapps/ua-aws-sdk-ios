//
//  UARDSCreateOptionGroupRequest.h
//  AWS iOS SDK
//
...
typedef void(^UARDSCreateOptionGroupRequestCompletionBlock)(UARDSOptionGroupResponse *response, NSError *error);
typedef BOOL(^UARDSCreateOptionGroupRequestShouldContinueWaitingBlock)(UARDSOptionGroupResponse *response, NSError *error);

@interface UARDSCreateOptionGroupRequest : UARDSRequest
