...
@class UAKMSCreateAliasResponse;

typedef void(^UAKMSCreateAliasRequestCompletionBlock)(UAKMSCreateAliasResponse *response, NSError *error);
typedef BOOL(^UAKMSCreateAliasRequestShouldContinueWaitingBlock)(UAKMSCreateAliasResponse *response, NSError *error);

@interface UAKMSCreateAliasRequest : UAKMSRequest

@property (nonatomic, copy) NSString *aliasName;
@property (nonatomic, copy) NSString *targetKeyID;
// @property (nonatomic, copy) UAKMSCreateAliasRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAKMSCreateAliasRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
