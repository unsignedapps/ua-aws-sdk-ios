...
@class UAKMSEnableKeyResponse;

typedef void(^UAKMSEnableKeyRequestCompletionBlock)(UAKMSEnableKeyResponse *response, NSError *error);
typedef BOOL(^UAKMSEnableKeyRequestShouldContinueWaitingBlock)(UAKMSEnableKeyResponse *response, NSError *error);

@interface UAKMSEnableKeyRequest : UAKMSRequest

@property (nonatomic, copy) NSString *keyID;
// @property (nonatomic, copy) UAKMSEnableKeyRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAKMSEnableKeyRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
