...
@class UAKMSListKeysResponse;

typedef void(^UAKMSListKeysRequestCompletionBlock)(UAKMSListKeysResponse *response, NSError *error);
typedef BOOL(^UAKMSListKeysRequestShouldContinueWaitingBlock)(UAKMSListKeysResponse *response, NSError *error);

@interface UAKMSListKeysRequest : UAKMSRequest

@property (nonatomic, strong) NSNumber *limit;
@property (nonatomic, copy) NSString *marker;
// @property (nonatomic, copy) UAKMSListKeysRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAKMSListKeysRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
