...
@class UAKMSRetireGrantResponse;

typedef void(^UAKMSRetireGrantRequestCompletionBlock)(UAKMSRetireGrantResponse *response, NSError *error);
typedef BOOL(^UAKMSRetireGrantRequestShouldContinueWaitingBlock)(UAKMSRetireGrantResponse *response, NSError *error);

@interface UAKMSRetireGrantRequest : UAKMSRequest

@property (nonatomic, copy) NSString *grantToken;
// @property (nonatomic, copy) UAKMSRetireGrantRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAKMSRetireGrantRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
