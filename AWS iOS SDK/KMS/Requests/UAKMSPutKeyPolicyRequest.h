...
@class UAKMSPutKeyPolicyResponse;

typedef void(^UAKMSPutKeyPolicyRequestCompletionBlock)(UAKMSPutKeyPolicyResponse *response, NSError *error);
typedef BOOL(^UAKMSPutKeyPolicyRequestShouldContinueWaitingBlock)(UAKMSPutKeyPolicyResponse *response, NSError *error);

@interface UAKMSPutKeyPolicyRequest : UAKMSRequest

@property (nonatomic, copy) NSString *keyID;
@property (nonatomic, copy) NSString *policyName;
@property (nonatomic, copy) NSString *policy;
// @property (nonatomic, copy) UAKMSPutKeyPolicyRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAKMSPutKeyPolicyRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
