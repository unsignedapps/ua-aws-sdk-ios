...
@class UAKMSDisableKeyResponse;

typedef void(^UAKMSDisableKeyRequestCompletionBlock)(UAKMSDisableKeyResponse *response, NSError *error);
typedef BOOL(^UAKMSDisableKeyRequestShouldContinueWaitingBlock)(UAKMSDisableKeyResponse *response, NSError *error);

@interface UAKMSDisableKeyRequest : UAKMSRequest

@property (nonatomic, copy) NSString *keyID;
// @property (nonatomic, copy) UAKMSDisableKeyRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAKMSDisableKeyRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
