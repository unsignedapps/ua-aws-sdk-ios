...
@class UAKMSGetKeyPolicyResponse;

typedef void(^UAKMSGetKeyPolicyRequestCompletionBlock)(UAKMSGetKeyPolicyResponse *response, NSError *error);
typedef BOOL(^UAKMSGetKeyPolicyRequestShouldContinueWaitingBlock)(UAKMSGetKeyPolicyResponse *response, NSError *error);

@interface UAKMSGetKeyPolicyRequest : UAKMSRequest

@property (nonatomic, copy) NSString *keyID;
@property (nonatomic, copy) NSString *policyName;
// @property (nonatomic, copy) UAKMSGetKeyPolicyRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAKMSGetKeyPolicyRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
