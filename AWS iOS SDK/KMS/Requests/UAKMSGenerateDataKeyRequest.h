...
@class UAKMSGenerateDataKeyResponse;

typedef void(^UAKMSGenerateDataKeyRequestCompletionBlock)(UAKMSGenerateDataKeyResponse *response, NSError *error);
typedef BOOL(^UAKMSGenerateDataKeyRequestShouldContinueWaitingBlock)(UAKMSGenerateDataKeyResponse *response, NSError *error);

@interface UAKMSGenerateDataKeyRequest : UAKMSRequest
...
// @property (nonatomic, copy) UAKMSGenerateDataKeyRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAKMSGenerateDataKeyRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
