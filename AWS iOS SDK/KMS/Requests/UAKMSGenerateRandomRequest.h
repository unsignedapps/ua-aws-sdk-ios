...
@class UAKMSGenerateRandomResponse;

typedef void(^UAKMSGenerateRandomRequestCompletionBlock)(UAKMSGenerateRandomResponse *response, NSError *error);
typedef BOOL(^UAKMSGenerateRandomRequestShouldContinueWaitingBlock)(UAKMSGenerateRandomResponse *response, NSError *error);

@interface UAKMSGenerateRandomRequest : UAKMSRequest

@property (nonatomic, strong) NSNumber *numberOfBytes;
// @property (nonatomic, copy) UAKMSGenerateRandomRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAKMSGenerateRandomRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
