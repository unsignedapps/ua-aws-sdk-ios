...
@class UAKMSDeleteAliasResponse;

typedef void(^UAKMSDeleteAliasRequestCompletionBlock)(UAKMSDeleteAliasResponse *response, NSError *error);
typedef BOOL(^UAKMSDeleteAliasRequestShouldContinueWaitingBlock)(UAKMSDeleteAliasResponse *response, NSError *error);

@interface UAKMSDeleteAliasRequest : UAKMSRequest

@property (nonatomic, copy) NSString *aliasName;
// @property (nonatomic, copy) UAKMSDeleteAliasRequestCompletionBlock UA_RequestCompletionBlock;
// @property (nonatomic, copy) UAKMSDeleteAliasRequestShouldContinueWaitingBlock UA_ShouldContinueWaiting;
