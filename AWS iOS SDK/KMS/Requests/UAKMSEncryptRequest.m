...
@implementation UAKMSEncryptRequest

@synthesize xAmzTarget=_xAmzTarget, keyID=_keyID, plaintext=_plaintext, encryptionContext=_encryptionContext, grantTokens=_grantTokens;

- (id)init
{
	if (self = [super init])
	{
		[self setXAmzTarget:@"TrentService.Encrypt"];
...
{
	return [UAKMSEncryptResponse class];
}
